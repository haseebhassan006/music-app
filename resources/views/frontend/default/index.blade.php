        ...
        @if(config('settings.module_podcast', true))
            <li class="side-menu-podcasts">
                <a href="{{ route('frontend.podcasts') }}">
                    ...
                    <span data-translate-text="PODCASTS">{{ __('web.PODCASTS') }}</span>
                </a>
            </li>
        @endif
...
<!--<div id="sidebar-playlists"> -->
             <div class="btm-side-bar">
              <p><img src="{{asset('frontend/img/plus-01.png')}}"></p>
              <button>CREATE PLAYLISTS</button>
              <p><a href="#">YOUR PLAYLISTS <i class="fa fa-angle-down"></i></a></p>
              <div class="row px-4">
                <div class="col-md-4">
                  <img src="{{asset('frontend/img/001.png')}}">
                </div>
                <div class="col-md-4">
                  <img src="{{asset('frontend/img/002.png')}}">
                </div>
                <div class="col-md-4">
                  <img src="{{asset('frontend/img/003.png')}}">
                </div>
                <div class="col-md-4">
                  <img src="{{asset('frontend/img/004.png')}}">
                </div>
                <div class="col-md-4">
                  <img src="{{asset('frontend/img/005.png')}}">
                </div>
                <div class="col-md-4">
                  <img src="{{asset('frontend/img/006.png')}}">
                </div>
                <div class="col-md-4">
                  <img src="{{asset('frontend/img/007.png')}}">
                </div>
                <div class="col-md-4">
                  <img src="{{asset('frontend/img/008.png')}}">
                </div>
                <div class="col-md-4">
                  <img src="{{asset('frontend/img/009.png')}}">
                </div>
                <div class="col-md-4">
                  <img src="{{asset('frontend/img/009.png')}}">
                </div>
