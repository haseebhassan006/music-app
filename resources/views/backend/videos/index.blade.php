...
@section('content')
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Videos ({{ $total_videos }})</li>
    </ol>
    <div class="row">
        <div class="col-lg-12">
            <div class="card shadow mb-4">
                <div class="card-header py-3 border-0">
                    <button class="btn btn-link p-0 m-0" type="button" data-toggle="collapse" data-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                        <h6 class="m-0 font-weight-bold text-primary">Advanced video search</h6>
                    </button>
                </div>
                        ...
                        <div id="collapseOne" class="collapse p-4" aria-labelledby="headingOne" data-parent="#collapseMetaTags">
                            <form class="search-form" action="{{ route('backend.songs') }}">
                                ...
                                <div class="form-group row multi-artists">
                                    ...
                                    <div class="col-sm-10">
                                        <select class="form-control multi-selector-without-sortable" data-ajax--url="/api/search/album" name="albumIds[]" multiple="">
