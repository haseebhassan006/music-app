...
@section('content')
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Bulk Upload Video</li>
    </ol>
    <div class="row">
        <div class="col-12">
            <div class="uploaded-files card-columns card-2-columns"></div>
            <form id="fileupload" method="POST" enctype="multipart/form-data" action="{{ route('backend.upload.bulkvideo')  }}">
                <div class="upload-container">
                    <div id="upload-file-button" class="btn btn-primary btn-secondary">
                        ...
                        <span data-translate-text="PLAY_PLAYLIST">Upload Your Video</span>
                        <input id="upload-file-input" type="file" accept="video/*" name="file" multiple>
                    </div>
