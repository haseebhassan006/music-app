    ...
    <div class="row">
        <div class="col-lg-12">
            <form method="post" action="" class="form-horizontal" enctype="multipart/form-data">
                ...
                <div class="form-group">
                <label style="margin-bottom: 15px; display:block;">Make this genre as:</label>
                      <label style="margin-right: 15px;"><input type="radio" name="colorRadio" value="main" checked> main category</label>
                      <label style="margin-right: 15px;"><input type="radio" name="colorRadio" value="sub">  sub category</label>
                      <label style="margin-right: 15px;"><input type="radio" name="colorRadio" value="child"> child category</label>
                 </div>

                 <div class="main selectt">

                 </div>

                 <div class="sub selectt">
                 <div class="form-group ">
                    <label>Choose main category</label>
                    <select class="form-control select2-active" name="main">
                    <option selected="true" disabled="disabled">Select</option> 
                        {!! genreMainSelection('main') !!}
                    </select>
                </div>
                </div>

                <div class="child selectt">
                <div class="form-group ">
                    <label>Choose main category</label>
                    <select class="form-control select2-active"  name="parent" onchange="return getParentId(this);">
                    <option selected="true" disabled="disabled">Select</option> 
                    {!! genreMainSelection('parent') !!}
                    </select>
                </div>
                <div class="form-group">
                    <label>Choose sub category</label>
                    <select class="form-control select2-active" name="sub"id="main-cat" >
                    </select>
                </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="input-group col-xs-12">
                        <input type="file" name="artwork" class="file-selector" accept="image/*" {{ isset($genre) ?: '' }}>
