...
@section('content')
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">{{ isset($data) ? $data->name : 'Add new main category' }}</li>
    </ol>
    <div class="row">
        <div class="col-lg-12">
            <form role="form" method="post" action="{{ route('backend.maincategories.add.category') }}" enctype="multipart/form-data">
                @csrf
