...
<a class="btn share desktop" data-type="artist" data-id="<?php echo e($artist->id); ?>">
...
<a class="btn options mobile" data-toggle="contextmenu" data-trigger="left" data-type="artist" data-id="<?php echo e($artist->id); ?>">
...
<?php if(! $artist->verified): ?>
    <a class="btn dropdown desktop artist-page-settings-menu" data-type="artist" data-id="<?php echo e($artist->id); ?>">
...
<?php endif; ?><?php /**PATH D:\ali-shiwani\laragon\www\live-streaming\resources\views\frontend\default/artist/actions.blade.php ENDPATH**/ ?>