        ...
        <?php $__currentLoopData = $songs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $song): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            <div class="flat-song-list">
                <div class="flat-song-list-play-container">
                    <a title="Play" class="flat-song-list-play-button play-object" data-type="song" data-id="<?php echo e($song->id); ?>" style="background-image: url('<?php echo e($song->artwork_url); ?>')">
                ...
                <div class="flat-song-list-info">
                    <div class="flat-song-list-info-inner">
                        <div title="Curiosidad" class="css-bzqkha">
                            <a href="<?php echo e($song->permalink_url); ?>"><?php echo $song->title; ?></a></div>
                        <div class="css-kkg4pz">
                            <?php $__currentLoopData = $song->artists; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $artist): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><a href="<?php echo e($artist->permalink_url); ?>" class="text-secondary" title="<?php echo $artist->name; ?>"><?php echo $artist->name; ?></a><?php if(!$loop->last): ?>, <?php endif; ?> <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </div>
                    </div>
                </div>
                <div title="Hopeful, Restless" class="css-4ehc5e">
                    <?php if(count($song->genres)): ?>
                        <?php $__currentLoopData = $song->genres; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $genre): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><a class="text-secondary" href="<?php echo e($genre->permalink_url); ?>"><?php echo e($genre->name); ?></a><?php if(!$loop->last): ?>, <?php endif; ?> <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    <?php endif; ?>
                </div>

                <div class="flat-song-list-subtitle text-secondary"><?php echo e(humanTime($song->duration)); ?></div>
                <div class="flat-song-list-subtitle text-secondary"><?php echo e(__('symbol.' . config('settings.currency', 'USD'))); ?><?php echo e($song->price); ?></div>

                <button class="flat-song-list-button" data-action="share" data-type="song" data-id="<?php echo e($song->id); ?>">
                    <svg width="24" height="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" fill="#FFF">
                ...
                <?php else: ?>
                    <button title="buy" class="flat-song-list-button" data-action="buy" data-orderable-type="App\Models\Song" data-orderable-id="<?php echo e($song->id); ?>">
    ...
    <?php else: ?>
        <div class="empty-page following">
            <div class="empty-inner">
                <h2 data-translate-text="NO_RESULTS_FOUND"><?php echo e(__('web.NO_RESULTS_FOUND')); ?></h2>
            </div>
        </div>
    <?php endif; ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\live-streaming\resources\views\frontend\default/store/index.blade.php ENDPATH**/ ?>