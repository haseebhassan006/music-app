        ...
        <div class="swiper-container swiper-container-slide">
            <div class="swiper-wrapper">
                <?php $__currentLoopData = $slides; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $slide): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php if(isset($slide->object->id)): ?>
                        <script>var <?php echo e($slide->object_type); ?>_data_<?php echo e($slide->object->id); ?> = <?php echo json_encode($slide->object, 15, 512) ?></script>
                        <div class="module module-cell swiper station swiper-slide draggable" data-toggle="contextmenu" data-trigger="right" data-type="<?php echo e($slide->object_type); ?>" data-id="<?php echo e($slide->object->id); ?>">
                            <div class="module-inner">
                                <?php if($slide->title_link): ?>
                                    <a class="slide-title" href="<?php echo e(url($slide->title_link)); ?>"><?php echo e($slide->title); ?></a>
                                <?php else: ?>
                                    <span class="slide-title"><?php echo e($slide->title); ?></span>
                                <?php endif; ?>
                                <?php if(isset($slide->object->name) && isset($slide->object->permalink_url)): ?>
                                    <a class="object-title" href="<?php echo e($slide->object->permalink_url); ?>"><?php echo e($slide->object->name); ?></a>
                                <?php else: ?>
                                    <span class="object-title" href="<?php echo e($slide->object->permalink_url); ?>"><?php echo e($slide->object->title); ?></span>
                                <?php endif; ?>
                                <span class="object-description"><?php echo e($slide->description); ?></span>
                            </div>
                            <div class="img-container">
                                <a href="<?php echo e($slide->object->permalink_url); ?>">
                                    <img class="img" src="<?php echo e($slide->artwork_url); ?>">
                                </a>
                                <div class="actions primary">
                                    <?php if($slide->object_type == 'song' || $slide->object_type == 'station'): ?>
                                        <a class="btn play-lg play-object" data-type="<?php echo e($slide->object_type); ?>" data-id="<?php echo e($slide->object->id); ?>">
                                    ...
                                    <?php else: ?>
                                        <a class="btn play play-lg play-object" data-type="<?php echo e($slide->object_type); ?>" data-id="<?php echo e($slide->object->id); ?>">
                                            <div></div>
                                            <svg class="icon-play" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path d="M8 5v14l11-7z"/><path d="M0 0h24v24H0z" fill="none"/></svg>
                                        </a>
                                    <?php endif; ?>
...
<?php endif; ?><?php /**PATH D:\ali-shiwani\laragon\www\live-streaming\resources\views\frontend\default/commons/slideshow.blade.php ENDPATH**/ ?>