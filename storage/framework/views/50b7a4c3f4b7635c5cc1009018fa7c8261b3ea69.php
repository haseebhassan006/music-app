...
<head>
    ...
    <meta http-equiv="Content-type" content="text/html;charset=<?php echo e(config('settings.charset', 'utf-8')); ?>">
    ...
    <link id="favicon" rel="icon" href="<?php echo e(asset('skins/default/images/favicon.png')); ?>" type="image/png" sizes="16x16 32x32">
    <link rel="stylesheet" href="<?php echo e(asset('skins/default/css/bootstrap.css')); ?>" type="text/css">
    <link rel="stylesheet" href="<?php echo e(asset('skins/default/css/swiper.css?version=' . env('APP_VERSION'))); ?>" type="text/css">
    <link rel="stylesheet" href="<?php echo e(asset('skins/default/css/select2.css?version=' . env('APP_VERSION'))); ?>" type="text/css">
    <link rel="stylesheet" href="<?php echo e(asset('skins/default/css/jqueryui.css?version=' . env('APP_VERSION'))); ?>" type="text/css">
    <link rel="stylesheet" href="<?php echo e(asset('skins/default/css/app.css?version=' . env('APP_VERSION'))); ?>" type="text/css">
    <link rel="stylesheet" href="<?php echo e(asset('skins/default/css/cart.css?version=' . env('APP_VERSION'))); ?>" type="text/css">
    <link rel="stylesheet" href="<?php echo e(asset('skins/default/css/comments.css?version=' . env('APP_VERSION'))); ?>" type="text/css">
    <link rel="stylesheet" href="<?php echo e(asset('skins/default/css/reaction.css?version=' . env('APP_VERSION'))); ?>" type="text/css">
    <link rel="stylesheet" href="<?php echo e(asset('skins/default/css/jquery-contextmenu.css?version=' . env('APP_VERSION'))); ?>">
    ...
    <link rel="stylesheet" href="<?php echo e(asset('skins/default/css/new-home-style.css?version=' . env('APP_VERSION'))); ?>" type="text/css">
...
<div class="home-new-design-main" style="background-image: url(<?php echo e(asset('skins/default/images/home-new-banner.png?version=' . env('APP_VERSION'))); ?>)">
    <div id="fb-root"></div>
    <div id="header-container">
        <div class="row">
            <div class="col-md-2 offset-md-5 text-center">
            <div id="logo" class="desktop">
            <a href="<?php echo e(route('frontend.homepage')); ?>" class="logo-link"></a>
        </div>
            </div>
            <div class="col-md-5">
            ...
            <form id="header-search">
                ...
                <input class="search" name="q" value="" autocomplete="off" type="text" placeholder="<?php echo e(__('web.SEARCH_FOR_MUSIC')); ?>">
        ...
        <div id="header-user-assets" class="session desktop">
            ...
            <?php if(! config('settings.disable_register')): ?>
                <a id="header-signup-btn" class="create-account" data-translate-text="BECOME_A_MEMBER"><?php echo e(__('web.BECOME_A_MEMBER')); ?></a>
            <?php endif; ?>
            <div id="account-buttons" class="user-asset">
                <div class="btn-group no-border-left">
                    ...
                    <a id="upload-button" href="<?php echo e(route('frontend.auth.upload')); ?>" class="btn upload-music hide">
                        <svg height="29" viewBox="0 0 24 24" width="15" xmlns="http://www.w3.org/2000/svg">
                            <path d="M0 0h24v24H0z" fill="none"/>
                    ...
                    <?php if(config('settings.module_store', true)): ?>
            ...
            <a id="header-login-btn" class="login" data-translate-text="SIGN_IN"><?php echo e(__('web.SIGN_IN')); ?></a>
        </div>
    ...
    <div class="cart">
        <div role="menu" class="dropdown-menu dropdown-menu--xs-full">
            <div class="container">
                ...
                <div class="cart__top" data-translate-text="RECENT_ADDED_ITEMS"><?php echo e(__('web.RECENT_ADDED_ITEMS')); ?></div>

                <ul id="cart-items"></ul>
                <div class="cart__bottom">
                    <div class="cart__total"><?php echo e(__('web.SUBTOTAL')); ?> <span class="text-primary"><?php echo e(config('settings.currency', 'USD')); ?> 0.00</span></div>
                    <a class="btn btn-primary btn-checkout" href="<?php echo e(route('frontend.cart')); ?>" data-translate-text="CHECKOUT"><?php echo e(__('web.CHECKOUT')); ?></a>
                    <!--
                        <a class="btn btn--ys btn-secondary" href="<?php echo e(route('frontend.cart')); ?>">View Cart</a>
                    -->
                </div>
            </div>
        </div>
            ...
            <div class="right_menu">
                ...
                <aside id="sideMenu">
                    <div id="side-logo" class="mobile">
                        <a href="https://phpstack-613909-1990402.cloudwaysapps.com" data-action="sidebar-dismiss">
                        <img src="https://phpstack-613909-1990402.cloudwaysapps.com/skins/default/images/favicon.png">
                        <span data-translate-text="HOME">Home</span>
                        </a>
                    </div>
                    <ul id="aside_ul">
                        <li class="side-menu-home desktop">
                            <a href="https://phpstack-613909-1990402.cloudwaysapps.com">
                        ...
                        <li class="side-menu-discover">
                            <a href="https://phpstack-613909-1990402.cloudwaysapps.com/discover">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                                    <path d="M0 0h24v24H0z" fill="none"/>
                        ...
                        <li class="side-menu-community">
                            <a href="https://phpstack-613909-1990402.cloudwaysapps.com/community">
                        ...
                        <li class="side-menu-store">
                            <a href="https://phpstack-613909-1990402.cloudwaysapps.com/store">
                        ...
                        <li class="side-menu-radio">
                            <a href="https://phpstack-613909-1990402.cloudwaysapps.com/radio">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                        ...
                        <li class="side-menu-blog">
                            <a href="https://phpstack-613909-1990402.cloudwaysapps.com/blog">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                                    <path d="M0 0h24v24H0z" fill="none"/>
                        ...
                        <li class="side-menu-blog">
                            <a href="javascript:;">
                                ...
                                <span data-translate-text="HOME_BLOG">VIDEOS</span>
                            </a>
                        </li>
                        <li class="side-menu-blog">
                            <a href="javascript:;">
                                ...
                                <span data-translate-text="HOME_BLOG">EBOOKS</span>
                            </a>
                        </li>
                        <li class="side-menu-blog">
                            <a href="javascript:;">
                                <span data-translate-text="HOME_BLOG">ARTISTS</span>
                            </a>
                        </li>
                        <li class="side-menu-blog">
                            <a href="javascript:;">
                                <span data-translate-text="HOME_BLOG">USERS</span>
                            </a>
                        </li>
                        <li class="side-menu-blog">
                            <a href="javascript:;">
                                <span data-translate-text="HOME_BLOG">DATABASE</span>
                            </a>
                        </li>
                    </ul>
                    ...
                    <div class="home-playlist-left">
                        <div class="home-playlist-top-btn">
                            <span><img src="images/plus-icn.png"></span>
                            <button class="home-playlist-btn">CREATE PLAYLISTS</button>
                        </div> 
                        <div class="home-playlist-gallery">
                            <div class="home-playlist-gallery-head">
                                <h5>YOUR PLAYLISTS</h5>
                                <img src="images/down-arw.png">
                            </div>
                            <div class="home-playlist-gallery-box">
                                <div class="home-playlist-gallery-sing-bx">
                                    <img src="images/play-list1.png">
                                </div>
                                <div class="home-playlist-gallery-sing-bx">
                                    <img src="images/play-list2.png">
                                </div>
                                <div class="home-playlist-gallery-sing-bx">
                                    <img src="images/play-list3.png">
                                </div>
                                <div class="home-playlist-gallery-sing-bx">
                                    <img src="images/play-list4.png">
                                </div>
                                <div class="home-playlist-gallery-sing-bx">
                                    <img src="images/play-list5.png">
                                </div>
                                <div class="home-playlist-gallery-sing-bx">
                                    <img src="images/play-list6.png">
                                </div>
                                <div class="home-playlist-gallery-sing-bx">
                                    <img src="images/play-list1.png">
                                </div>
    ...
    <div class="contact-sidebar">
        <div id="sidebar-community">
            <div class="sidebar-title">
                <span class="community-link" data-translate-text="COMMUNITY"><?php echo e(__('web.COMMUNITY')); ?></span>
                <span class="drag-handle"></span>
            </div>
            <div id="chat-disconnected" class="hide">
                <p data-translate-text="MANATEE_DISCONNECTED"><?php echo e(__('web.MANATEE_DISCONNECTED')); ?></p> <a id="manatee-reconnect" class="btn" data-translate-text="MANATEE_RECONNECT"><?php echo e(__('web.MANATEE_RECONNECT')); ?></a> </div>
            <div id="friends-failed" class="hide">
                <p data-translate-text="POPUP_ERROR_LOAD_FRIENDS"><?php echo e(__('web.POPUP_ERROR_LOAD_FRIENDS')); ?></p>
            </div>
            <div id="sidebar-friends" class="friend-list hide">

            </div>
            <div id="sidebar-no-friends" class="sidebar-empty">
                <p class="label" data-translate-text="SIDEBAR_NO_FRIENDS"><?php echo e(__('web.SIDEBAR_NO_FRIENDS')); ?></p>
                <a class="btn btn-secondary share share-profile" data-translate-text="SHARE_YOUR_PROFILE" data-type="user"><?php echo e(__('web.SHARE_YOUR_PROFILE')); ?></a>
            </div>
            <div id="sidebar-invite-cta" class="hide">
                <p data-translate-text="INVITE_YOUR_FRIENDS"><?php echo e(__('web.INVITE_YOUR_FRIENDS')); ?></p>
                <a class="btn invite-friends share" data-type="user" data-translate-text="INVITE_FRIENDS"><?php echo e(__('web.INVITE_FRIENDS')); ?></a>
            </div>
        </div>

        <div id="sidebar-offline-msg" class="hide"> <span data-translate-text="OFFLINE_MSG"><?php echo e(__('web.OFFLINE_MSG')); ?></span><br> <a id="sidebar-go-online" data-translate-text="GO_ONLINE"><?php echo e(__('web.GO_ONLINE')); ?></a> <i id="close-offline-msg" class="icon ex icon-ex-l-gray-flat"></i> </div>
        <div id="sidebar-filter-container" class="hide">
            <form class="search-bar">
                <svg class="icon search" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path d="M15.5 14h-.79l-.28-.27C15.41 12.59 16 11.11 16 9.5 16 5.91 13.09 3 9.5 3S3 5.91 3 9.5 5.91 16 9.5 16c1.61 0 3.09-.59 4.23-1.57l.27.28v.79l5 4.99L20.49 19l-4.99-5zm-6 0C7.01 14 5 11.99 5 9.5S7.01 5 9.5 5 14 7.01 14 9.5 11.99 14 9.5 14z"></path><path d="M0 0h24v24H0z" fill="none"></path></svg>
                <span data-translate-text="FILTER" class="placeholder"><?php echo e(__('web.FILTER')); ?></span>
        ...
        <div class="user-section">
            <div class="inner-us">
                ...
                <div class="user-subscription-helper after-login hide">
                    <div class="user-subscription-text" data-translate-text="USER_SUBSCRIBED_DESCRIPTION"><?php echo e(__('web.USER_SUBSCRIBED_DESCRIPTION')); ?></div>
                    <a href="<?php echo e(route('frontend.settings.subscription')); ?>" class="user-subscription-button" data-translate-text="SUBSCRIBE"><?php echo e(__('web.SUBSCRIBE')); ?></a>
                </div>
                ...
                <div class="setting-wrap separate">
                    <ul class="user_options">
                        <li>
                            ...
                            <a href="<?php echo e(route('frontend.homepage')); ?>" data-translate-text="HOME"><?php echo e(__('web.HOME')); ?></a>
                        </li>
                        <li>
                            ...
                            <a class="show-lightbox" data-lightbox="lightbox-locale" data-translate-text="LANGUAGE"><?php echo e(__('web.LANGUAGE')); ?></a>
                        </li>
                        <li>
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path d="M20 4H4c-1.1 0-1.99.9-1.99 2L2 18c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zm0 4l-8 5-8-5V6l8 5 8-5v2z"/><path d="M0 0h24v24H0z" fill="none"/></svg>
                            <a class="show-lightbox" data-lightbox="lightbox-feedback" data-translate-text="FEEDBACK"><?php echo e(__('web.FEEDBACK')); ?></a>
                        </li>
                        <li>
                            ...
                            <span data-translate-text="BLACK_THEME"><?php echo e(__('web.DARK_MODE')); ?></span>
                            <label class="switch"><input type="checkbox" class="themeSwitch" <?php if((isset($_COOKIE['darkMode']) && $_COOKIE['darkMode'] == 'true') || ! isset($_COOKIE['darkMode'])): ?> checked="checked" <?php endif; ?>><span class="slider round"></span></label>
                        </li>
                    </ul>
                </div>
                <div class="user-auth hide user-setting-wrap separate">
                    <ul class="user_options">
                        <li>
                            ...
                            <a href="<?php echo e(route('frontend.auth.upload')); ?>">
                                <span><?php echo e(__('web.UPLOAD')); ?></span>
                            </a>
                        </li>
                        <li id="artist-management-link" class="hide">
                            ...
                            <a href="<?php echo e(route('frontend.auth.user.artist.manager')); ?>">
                                <span><?php echo e(__('web.CONTEXT_ARTIST_MANAGER')); ?></span>
                            </a>
                        </li>
                        <li>
                            <svg height="24" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <li>
                            ...
                            <a class="auth-my-purchased-link"><?php echo e(__('web.PURCHASED')); ?></a>
                        </li>
                        <li>
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 20 20"><path fill="none" d="M0 0h20v20H0V0z"></path><path d="M15.95 10.78c.03-.25.05-.51.05-.78s-.02-.53-.06-.78l1.69-1.32c.15-.12.19-.34.1-.51l-1.6-2.77c-.1-.18-.31-.24-.49-.18l-1.99.8c-.42-.32-.86-.58-1.35-.78L12 2.34c-.03-.2-.2-.34-.4-.34H8.4c-.2 0-.36.14-.39.34l-.3 2.12c-.49.2-.94.47-1.35.78l-1.99-.8c-.18-.07-.39 0-.49.18l-1.6 2.77c-.1.18-.06.39.1.51l1.69 1.32c-.04.25-.07.52-.07.78s.02.53.06.78L2.37 12.1c-.15.12-.19.34-.1.51l1.6 2.77c.1.18.31.24.49.18l1.99-.8c.42.32.86.58 1.35.78l.3 2.12c.04.2.2.34.4.34h3.2c.2 0 .37-.14.39-.34l.3-2.12c.49-.2.94-.47 1.35-.78l1.99.8c.18.07.39 0 .49-.18l1.6-2.77c.1-.18.06-.39-.1-.51l-1.67-1.32zM10 13c-1.65 0-3-1.35-3-3s1.35-3 3-3 3 1.35 3 3-1.35 3-3 3z"></path></svg>
                            <a href="<?php echo e(route('frontend.settings')); ?>">Settings</a>
                        </li>
                    </ul>
                </div>
...
<?php if(config('settings.landing') && ! auth()->check()): ?>
    <?php echo $__env->make('landing.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php endif; ?>
<div class="home-new-design-sub-cnt">
    <div id="main">
        <div id="page">
...
<?php echo $__env->make('lightbox', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php echo $__env->make('jstemplate', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
</html><?php /**PATH D:\ali-shiwani\laragon\www\live-streaming\resources\views\frontend\default/index_new.blade.php ENDPATH**/ ?>