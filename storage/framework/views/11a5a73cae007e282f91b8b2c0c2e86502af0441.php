<?php $__env->startSection('pagination'); ?>
    <?php echo $__env->make('commons.activity', ['activities' => $community->activities, 'type' => 'full'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    ...
    <div id="page-content" class="community logged-out">
        <div class="container">
            <div class="page-header community main no-separator desktop">
                <h1 id="community-header" data-translate-text="COMMUNITY"><?php echo e(__('web.COMMUNITY')); ?></h1>
            </div>
            <div id="column1" class="community-feed full">
                <?php echo $__env->make('commons.slideshow', ['slides' => $slides], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                ...
                <?php if(auth()->check()): ?>
                    <div id="post-to-feed" class="post-item">
                        ...
                        <div class="post-container">
                            <div class="post-msg">
                                <div class="post-feed-msg" contentEditable="true" placeholder="<?php echo e(__('web.PLACEHOLDER_USER_FEED_SHARE')); ?>"></div>
                            ...
                            <a class="btn dropdown-toggle attach-music">
                                <span class="label" data-translate-text="ATTACH_MUSIC"><?php echo e(__('web.ATTACH_MUSIC')); ?></span>
                ...
                <?php endif; ?>
                <div id="community" class="content infinity-load-more" data-total-page="<?php echo e(20); ?>">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\ali-shiwani\laragon\www\live-streaming\resources\views\frontend\default/community/index.blade.php ENDPATH**/ ?>