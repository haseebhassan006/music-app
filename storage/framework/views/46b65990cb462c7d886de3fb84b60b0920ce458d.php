<?php $__env->startSection('lightbox-close'); ?>
...
<div id="lightbox-outer">
    <div class="lightbox lightbox-confirm hide">
        <div class="lbcontainer">
            <div class="lightbox-header">
                <h2 class="title"><?php echo e(__('web.LB_START_RADIO_TITLE')); ?></h2>
                <?php echo $__env->yieldContent('lightbox-close'); ?>
            </div>
            ...
            <div class="lightbox-footer">
                <div class="left-btns"><a class="btn btn-secondary close" data-translate-text="CANCEL"><?php echo e(__('web.CANCEL')); ?></a></div>
                <div class="right-btns"><a class="btn btn-primary submit"><?php echo e(__('web.OK')); ?></a></div>
            </div>
        </div>
    </div>
    <div class="lightbox lightbox-claimArtist hide">
        <div class="lbcontainer">
            <div id="claimArtistLightbox">
                <div class="lightbox-header">
                    <h2 class="title" data-translate-text="CLAIM_ARTIST"><?php echo e(__('web.CLAIM_ARTIST')); ?></h2>
                    <?php echo $__env->yieldContent('lightbox-close'); ?>
                </div>
                <ul id="lightbox-stages-header" class="">
                    <li class="lightbox-stage active" rel="account">
                        ...
                        </div> <?php echo e(__('web.VERIFY_ACCOUNT')); ?><div class="arrow"></div>
                    </li>
                    <li class="lightbox-stage" rel="info">
                        ...
                        </div> <?php echo e(__('web.INFORMATION')); ?><div class="arrow"></div>
                    </li>
                    <li class="lightbox-stage" rel="done">
                        <div class="circle">
                            <svg class="icon" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path fill="none" d="M0 0h24v24H0V0zm0 0h24v24H0V0z"/><path d="M16.59 7.58L10 14.17l-3.59-3.58L5 12l5 5 8-8zM12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 18c-4.42 0-8-3.58-8-8s3.58-8 8-8 8 3.58 8 8-3.58 8-8 8z"/></svg>
                        </div> <?php echo e(__('web.FINISHED')); ?><div class="arrow"></div>
                    </li>
                </ul>
                <div class="lightbox-content">
                    ...
                    <div class="lightbox-content-block">
                        <div id="artist-claiming-stage-account" class="claiming-stage">
                            <p data-translate-text="VERIFY_ACCOUNT_EMAIL_MESSAGE"><?php echo e(__('web.VERIFY_ACCOUNT_EMAIL_MESSAGE')); ?></p>
                            <div class="control-group floated"><label class="control-label" for="artist-claiming-email" data-translate-text="FORM_EMAIL_ADDRESS"><?php echo e(__('web.FORM_EMAIL_ADDRESS')); ?></label>
                                <div class="control"><input type="text" id="artist-claiming-email" value=""></div>
                            </div>
                            <div class="control-group floated"><label class="control-label" for="artist-claiming-fname" data-translate-text="FORM_FULL_NAME"><?php echo e(__('web.FORM_FULL_NAME')); ?></label>
                                <div class="control"><input type="text" id="artist-claiming-fname" value=""></div>
                            </div>
                            <div class="control-group password-container hide"><label class="control-label" for="artist-claiming-password" data-translate-text="FORM_PASSWORD_REQUIRED">><?php echo e(__('web.FORM_PASSWORD_REQUIRED')); ?></label>
                        ...
                        <div id="artist-claiming-stage-info" class="claiming-stage hide">
                            <div id="artist-claiming-name-container" class="control-group">
                                <label class="control-label" for="artist-claiming-email" data-translate-text="FORM_ARTIST_OR_BAND"><?php echo e(__('web.FORM_ARTIST_OR_BAND')); ?></label>
                                <form id="artist-claim-search-form" class="control artist-search-container ajax-form" method="GET" action="<?php echo e(url('api/search/artist')); ?>">
                                    <button type="submit" class="btn btn-secondary search" data-translate-text="SEARCH"><?php echo e(__('web.SEARH')); ?></button>
                                ...
                                <div id="window-claim-artist-selector" class="window-selector-container hide">
                                    <span id="selected-create-text" class="control-label d-block text-center mb-2" data-translate-text="LB_CLAIM_ARTIST_CHOOSE_PROFILE_TOP"><?php echo e(__('web.LB_CLAIM_ARTIST_CHOOSE_PROFILE_TOP')); ?></span>
                                    ...
                                    <div class="others hide">
                                        <span class="control-label text-center d-block text-center mb-2" data-translate-text="LB_CLAIM_ARTIST_CHOOSE_PROFILE_OTHERS"><?php echo e(__('web.LB_CLAIM_ARTIST_CHOOSE_PROFILE_OTHERS')); ?></span>
                            ...
                            <div class="control-group">
                                <div class="control"><label class="control-label" for="artist-claiming-phone" data-translate-text="FORM_PHONE"><?php echo e(__('web.FORM_PHONE')); ?></label><input type="text" id="artist-claiming-phone" value=""></div>
                                <div class="control"><label class="control-label" for="artist-claiming-phone-ext" data-translate-text="FORM_PHONE_EXT"><?php echo e(__('web.FORM_PHONE_EXT')); ?></label><input type="text" id="artist-claiming-phone-ext" value=""></div>
                                <div class="control"><label class="control-label" for="artist-claiming-affiliation" data-translate-text="FORM_ARTIST_AFFILIATION"><?php echo e(__('web.FORM_ARTIST_AFFILIATION')); ?></label>
                                    <select id="artist-claiming-affiliation" class="span2">
                                        <option value=""><?php echo e(__('web.FORM_SELECT_AN_OPTION')); ?></option>
                                        <option value="Artist/Band Member"><?php echo e(__('web.ARTIST_AFFILIATION_1')); ?></option>
                                        <option value="Manager"><?php echo e(__('web.ARTIST_AFFILIATION_2')); ?></option>
                                        <option value="Label"><?php echo e(__('web.ARTIST_AFFILIATION_3')); ?></option>
                                        <option value="Other"><?php echo e(__('web.ARTIST_AFFILIATION_4')); ?></option>
                                    </select>
                                </div>
                            </div>
                            <div class="message-container"><label class="control-label" for="artist-claiming-message" data-translate-text="EXPLAIN_ARTIST_IDENTITY"><?php echo e(__('web.EXPLAIN_ARTIST_IDENTITY')); ?></label>
                                <div class="control"><textarea id="artist-claiming-message"></textarea></div>
                            </div>
                            <h3 data-translate-text="SPEED_UP_ARTIST_PROCESS"><?php echo e(__('web.SPEED_UP_ARTIST_PROCESS')); ?></h3>
                            <div class="connect-container">
                                ...
                                <span class="icon-message text-secondary small" data-translate-text="TWITTER_ARTIST_VERIFY_INSTRUCTIONS"><?php echo e(__('web.TWITTER_ARTIST_VERIFY_INSTRUCTIONS')); ?></span>
                                <a id="artist-twitter-connect" class="btn" data-translate-text="SETTINGS_NAV_THIRD_PARTY" data-action="social-login" data-service="twitter"><?php echo e(__('web.SETTINGS_NAV_THIRD_PARTY')); ?></a>
                            </div>
                            <div class="connect-container facebook">
                                ...
                                <div id="facebook-verify-connect">
                                    <span class="icon-message text-secondary small" data-translate-text="FACEBOOK_ARTIST_VERIFY_INSTRUCTIONS"><?php echo e(__('web.FACEBOOK_ARTIST_VERIFY_INSTRUCTIONS')); ?></span>
                                    <a id="artist-facebook-connect" class="btn" data-translate-text="SETTINGS_NAV_THIRD_PARTY" data-action="social-login" data-service="facebook"><?php echo e(__('web.SETTINGS_NAV_THIRD_PARTY')); ?></a>
                                </div>
                            </div>
                            <div class="connect-container passport">
                                ...
                                <h3 class="icon-name" data-translate-text="PASSPORT"><?php echo e(__('web.PASSPORT')); ?></h3>
                                <div id="passport-verify-connect">
                                    <span class="icon-message text-secondary small" data-translate-text="PASSPORT_TIP"><?php echo e(__('web.PASSPORT_TIP')); ?></span>
                                    <div class="btn">
                                        <span data-translate-text="BROWSE"><?php echo e(__('web.BROWSE')); ?></span>
                            ...
                            <div class="connect-container">
                                ...
                                <label class="lbl ml-4" for="accept-terms" data-translate-text="AGREE_ARTIST_TERMS"><?php echo e(__('web.AGREE_ARTIST_TERMS')); ?></label>
                            </div>
                        </div>
                        <div id="artist-claiming-stage-message" class="hide">
                            ...
                            <p class="claiming-success-message" data-translate-text="POPUP_CLAIM_ARTIST_SENT"><?php echo e(__('web.POPUP_CLAIM_ARTIST_SENT')); ?></p>
                        </div>
                    </div>
                </div>
                <div class="lightbox-footer">
                    <div class="right">
                        <a class="btn btn-primary continue" data-translate-text="CONTINUE"><?php echo e(__('web.CONTINUE')); ?></a>
                        <a class="btn btn-primary create hide" data-translate-text="CREATE_ARTIST"><?php echo e(__('web.CREATE_ARTIST')); ?></a>
                        <a class="btn btn-primary finished hide" data-translate-text="CLOSE"><?php echo e(__('web.CLOSE')); ?></a>
                        <a class="btn btn-primary submit hide" data-translate-text="ARTIST_CLAIM_SEND_REQUEST"><?php echo e(__('web.ARTIST_CLAIM_SEND_REQUEST')); ?></a></div>
                    <div class="left">
                        <a class="btn btn-secondary back hide" data-translate-text="BACK"><?php echo e(__('web.BACK')); ?></a>
                        <a class="btn btn-secondary close hide" data-translate-text="CLOSE"><?php echo e(__('web.CLOSE')); ?></a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="lightbox lightbox-radioClearQueue hide">
        <div class="lbcontainer">
            <form class="generic radioClearQueue">
                <div class="lightbox-header">
                    <h2 class="title" data-translate-text="LB_START_RADIO_TITLE"><?php echo e(__('web.LB_START_RADIO_TITLE')); ?></h2>
                    <?php echo $__env->yieldContent('lightbox-close'); ?>

                </div>
                <div class="lightbox-content">
                    <div class="lightbox-content-block">
                        <p data-translate-text="LB_START_RADIO_MESSAGE"><?php echo e(__('web.LB_START_RADIO_MESSAGE')); ?></p>
                    </div>
                </div>
                <div class="lightbox-footer">
                    <div class="left-btns"><a class="btn btn-secondary close" data-translate-text="CANCEL"><?php echo e(__('web.CANCEL')); ?></a></div>
                    <div class="right-btns"><a class="btn btn-primary submit " data-translate-text="LB_START_RADIO_TITLE"><?php echo e(__('web.LB_START_RADIO_TITLE')); ?></a></div>
                </div>
            </form>
        </div>
    </div>
    <div class="lightbox lightbox-login hide">
        <div class="lbcontainer">
            <div class="lightbox-header">
                <h2 class="title" data-translate-text="SIGN_IN"><?php echo e(__('web.SIGN_IN')); ?></h2>
                <?php echo $__env->yieldContent('lightbox-close'); ?>
            </div>
            <div class="lightbox-content">
                <div class="lightbox-content-block">
                                    ...
                                    <?php if(config('settings.facebook_login')): ?>
                                        <div class="col">
                                            <a class="lb-facebook-login btn share-btn third-party facebook" data-action="social-login" data-service="facebook">
                                                ...
                                                <span class="text desktop" data-translate-text="SIGN_IN_FACEBOOK"><?php echo e(__('web.SIGN_IN_FACEBOOK')); ?></span>
                                                <span class="text mobile" data-translate-text="FACEBOOK"><?php echo e(__('web.FACEBOOK')); ?></span>
                                            </a>
                                        </div>
                                    <?php endif; ?>
                                    <?php if(config('settings.google_login')): ?>
                                        <div class="col">
                                            <a class="lb-google-login btn share-btn third-party google" data-action="social-login" data-service="google">
                                                ...
                                                <span class="text desktop" data-translate-text="SIGN_IN_GOOGLE"><?php echo e(__('web.SIGN_IN_GOOGLE')); ?></span>
                                                <span class="text mobile" data-translate-text="GOOGLE"><?php echo e(__('web.GOOGLE')); ?></span>
                                            </a>
                                        </div>
                                    <?php endif; ?>
                                    <?php if(config('settings.twitter_login')): ?>
                                        <div class="col">
                                            <a class="lb-twitter-login btn share-btn third-party twitter" data-action="social-login" data-service="twitter">
                                                ...
                                                <span class="text desktop" data-translate-text="SIGN_IN_TWITTER"><?php echo e(__('web.SIGN_IN_TWITTER')); ?></span>
                                                <span class="text mobile" data-translate-text="TWITTER"><?php echo e(__('web.TWITTER')); ?></span>
                                            </a>
                                        </div>
                                    <?php endif; ?>
                                </div>
                    ...
                    <div id="lightbox-login-form-goes-here">
                        ...
                        <form id="lightbox-login-form" class="vertical" method="post">
                            <div class="row">
                                <?php if(config('settings.authorization_method', 0) == 0): ?>
                                    <div class="control-group col-lg-6 col-12">
                                        <label class="control-label" for="username" data-translate-text="FORM_USERNAME"><?php echo e(__('web.FORM_USERNAME')); ?></label>
                                        <div class="controls">
                                            <input class="login-text" id="login-username" name="username" type="text" autocapitalize="none" autocorrect="off">
                                        </div>
                                        <a class="open-signup small desktop" data-translate-text="LB_SIGNUP_LOGIN_DONT_HAVE_ACCOUNT_SUB"><?php echo e(__('web.LB_SIGNUP_LOGIN_DONT_HAVE_ACCOUNT_SUB')); ?></a>
                                    </div>
                                <?php else: ?>
                                    <div class="control-group col-lg-6 col-12">
                                        <label class="control-label" for="email" data-translate-text="FORM_EMAIL"><?php echo e(__('web.FORM_EMAIL')); ?></label>
                                        <div class="controls">
                                ...
                                <?php endif; ?>
                                <div class="control-group col-lg-6 col-12">
                                    <label class="control-label" for="password" data-translate-text="FORM_PASSWORD"><?php echo e(__('web.FORM_PASSWORD')); ?></label>
                                    <div class="controls">
                                        <input class="login-text" id="login-password" name="password" type="password">
                                    </div>
                                    <a class="forgot small" data-translate-text="FORM_FORGOT_PASSWORD"><?php echo e(__('web.FORM_FORGOT_PASSWORD')); ?></a>
                                </div>
                            </div>
                        </form>
                    </div>
            ...
            <div class="lightbox-footer">
                <div class="right">
                    <a class="btn btn-primary submit" data-translate-text="SIGN_IN"><?php echo e(__('web.SIGN_IN')); ?></a>
                </div>
                <?php if(! config('settings.disable_register')): ?>
                    <div id="lightbox-footer-left" class="left mobile">
                        <a class="btn btn-secondary open-signup" data-translate-text="LB_SIGNUP_LOGIN_DONT_HAVE_ACCOUNT_SUB"><?php echo e(__('web.LB_SIGNUP_LOGIN_DONT_HAVE_ACCOUNT_SUB')); ?></a>
                    </div>
                <?php endif; ?>
            </div>
        </div>
    ...
    <div class="lightbox lightbox-signup hide">
        <div class="lbcontainer">
            <form id="singup-form" method="POST" action="<?php echo e(route('frontend.auth.info.validate')); ?>">
                <div class="lightbox-header">
                    <h2 class="title" data-translate-text="POPUP_SIGNUP_TITLE"><?php echo e(__('web.POPUP_SIGNUP_TITLE')); ?></h2>
                    <?php echo $__env->yieldContent('lightbox-close'); ?>
                </div>
                <div class="lightbox-content">
                    <div class="lightbox-error error hide"></div>
                    <div class="lightboxsettings.disable_register-content-block">
                        <?php if(config('settings.disable_register')): ?>
                            <p class="mt-3 mb-3"><?php echo e(__('web.REGISTRATION_DISABLED')); ?></p>
                        <?php else: ?>
                            <?php if(config('settings.social_login')): ?>
                                <div class="lb-nav-outer">
                                    <div class="lb-nav-container no-center">
                            ...
                            <div id="signup-stage-singup" class="signup-stage">
                                <div class="row">
                                    <div class="control control-group col-lg-6 col-12">
                                        <label class="control-label" for="signup-email" data-translate-text="FORM_EMAIL_ADDRESS"><?php echo e(__('web.FORM_EMAIL_ADDRESS')); ?></label>
                                        <div class="controls"><input class="signup-text" id="signup-email" name="email" type="text"></div>
                                    </div>
                                    <div class="control control-group col-lg-6 col-12">
                                        <label class="control-label" for="signup-fname" data-translate-text="FORM_NAME"><?php echo e(__('web.FORM_NAME')); ?></label>
                                        <div class="controls"><input class="signup-text" id="signup-fname" name="name" type="text"></div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="control control-group col-lg-6 col-12">
                                        <label class="control-label" for="signup-password1" data-translate-text="FORM_PASSWORD"><?php echo e(__('web.FORM_PASSWORD')); ?></label>
                                        <div class="controls"><input class="signup-text" id="signup-password1" name="password" type="password"></div>
                                    </div>
                                    <div class="control control-group col-lg-6 col-12">
                                        <label class="control-label" for="signup-password2" data-translate-text="FORM_CONFIRM_PASSWORD"><?php echo e(__('web.FORM_CONFIRM_PASSWORD')); ?></label>
                                        <div class="controls"><input class="signup-text" id="signup-password2" name="password_confirmation" type="password"></div>
                                    </div>
                                </div>
                                <p class="tos small" data-translate-text="FORM_TOS_2"><?php echo e(__('web.FORM_TOS_2')); ?></p>
                            </div>
                            <div id="signup-stage-profile" class="signup-stage hide">
                                <div class="control-group custom-url">
                                    <label class="control-label" for="username" data-translate-text="LB_SIGNUP_FORM_URL"><?php echo e(__('web.LB_SIGNUP_FORM_URL')); ?></label>
                                    <div class="controls">
                                        <div class="input-prepend">
                                            <span class="add-on"><?php echo e(route('frontend.homepage')); ?>/</span>
                                ...
                                <p class="checkbox-container">
                                    ...
                                    <label class="lbl" for="im-artist" data-translate-text="IM_AN_ARTIST_SIGNUP"><?php echo e(__('web.IM_AN_ARTIST_SIGNUP')); ?></label>
                                </p>
                            </div>
                            <div id="signup-stage-verify" class="signup-stage hide">
                                <h2 class="text-center"  data-translate-text="LB_VERIFY_ACCOUNT"><?php echo e(__('web.LB_VERIFY_ACCOUNT')); ?></h2>
                                <p  data-translate-text="LB_VERIFY_ACCOUNT_DESCRIPTION"><?php echo e(__('web.LB_VERIFY_ACCOUNT_DESCRIPTION')); ?></p>
                            </div>
                            <div id="signup-stage-complete" class="signup-stage hide">
                                ...
                                <div class="complete-todo">
                                    <svg class="todo-icon profile" height="512" viewBox="0 0 480.063 480.063" width="512" xmlns="http://www.w3.org/2000/svg"><path d="m394.032 424.803v39.26c0 4.42-3.58 8-8 8h-292c-4.42 0-8-3.58-8-8v-39.26c0-41.19 33.39-74.56 74.59-74.57 14.56-.01 27.38-7.5 34.76-18.86 7.414-11.394 6.65-21.302 6.65-29.31l.15-.37c-35.9-14.86-61.15-50.23-61.15-91.5v-3.13c-14.255 0-25-11.265-25-24.54v-41.56c-.32-14.47.34-65.5 37.2-101.03 42.86-41.31 110.78-37.93 159.98-15.83 1.6.72 1.55 3.01-.07 3.68l-12.83 5.28c-1.92.79-1.51 3.62.55 3.84l6.23.67c29.83 3.19 57.54 19.39 74.72 46.35.46.73.33 1.84-.26 2.47-10.6 11.21-16.52 26.09-16.52 41.56v54.57c0 13.55-10.99 24.54-24.54 24.54h-1.46v3.13c0 41.27-25.25 76.64-61.15 91.5l.15.37c0 7.777-.827 17.82 6.65 29.31 7.38 11.36 20.2 18.85 34.76 18.86 41.2.01 74.59 33.38 74.59 74.57z" fill="#ffdfba"></path><path d="m394.032 424.803v39.26c0 4.418-3.582 8-8 8h-292c-4.418 0-8-3.582-8-8v-39.26c0-41.19 33.395-74.555 74.585-74.57 14.564-.005 27.387-7.504 34.765-18.86 25.754 22.002 63.531 22.015 89.3 0 7.377 11.356 20.201 18.855 34.765 18.86 41.19.015 74.585 33.38 74.585 74.57z" fill="#fe4f60"></path><path d="m381.807 83.928c.464.729.334 1.833-.259 2.461-10.597 11.218-16.517 26.093-16.517 41.564v54.57c0 12.388-9.333 24.54-26 24.54v-61.77c0-26.51-21.49-48-48-48h-102c-26.51 0-48 21.49-48 48v61.77c-14.255 0-25-11.265-25-24.54v-41.56c-.32-14.47.34-65.5 37.2-101.03 42.858-41.311 110.784-37.929 159.977-15.827 1.601.719 1.558 3.01-.065 3.678l-12.831 5.282c-1.918.79-1.514 3.617.548 3.838l6.232.669c29.834 3.187 57.537 19.387 74.715 46.355z" fill="#42434d"></path><path d="m339.032 210.193c0 54.696-44.348 99-99 99-51.492 0-99-40.031-99-102.13v-61.77c0-26.51 21.49-48 48-48h102c26.51 0 48 21.49 48 48z" fill="#ffebd2"></path><path d="m217.616 274.121c16.277 10.183 3.442 35.156-14.376 28.004-36.634-14.704-62.208-50.404-62.208-91.932v-64.9c0-10.084 3.11-19.442 8.423-27.168 6.514-9.473 21.577-5.288 21.577 7.168v64.9c0 36.51 19.192 66.79 46.584 83.928z" fill="#fff3e4"></path><path d="m279.162 318.483c-24.637 10.313-51.712 11.113-78.26 0 1.356-5.626 1.13-9.27 1.13-16.42l.15-.37c24.082 9.996 51.571 10.016 75.7 0l.15.37c0 7.153-.226 10.796 1.13 16.42z" fill="#ffd6a6"></path><path d="m200.913 374.39c-3.698 1.163-7.664 1.804-11.916 1.841-41.296.364-74.966 33.017-74.966 74.315v7.517c0 7.732-6.268 14-14 14h-6c-4.418 0-8-3.582-8-8v-39.26c0-41.191 33.395-74.555 74.585-74.57 14.564-.005 27.387-7.504 34.765-18.86 2.974 2.54 6.158 4.823 9.512 6.822 14.753 8.791 12.402 31.044-3.98 36.195z" fill="#ff6d7a"></path><path d="m279.15 374.39c3.698 1.163 7.664 1.804 11.916 1.841 41.296.364 74.966 33.017 74.966 74.315v7.517c0 7.732 6.268 14 14 14h6c4.418 0 8-3.582 8-8v-39.26c0-41.191-33.395-74.555-74.585-74.57-14.564-.005-27.387-7.504-34.765-18.86-2.974 2.54-6.158 4.823-9.512 6.822-14.753 8.791-12.402 31.044 3.98 36.195z" fill="#e84857"></path><path d="m313.142 27.783c-11.758 4.839-13.434 5.906-17.508 5.274-65.674-10.18-123.294 16.993-142.862 80.786v.01c-7.32 8.42-11.74 19.42-11.74 31.44v37.523c0 16.188-25 17.315-25-.293v-41.56c-.32-14.47.34-65.5 37.2-101.03 42.86-41.31 110.78-37.93 159.98-15.83 1.6.72 1.55 3.01-.07 3.68z" fill="#4d4e59"></path><path d="m402.032 424.806v47.257c0 4.418-3.582 8-8 8s-8-3.582-8-8v-47.257c0-36.795-29.775-66.572-66.573-66.571-17.411 0-33.208-8.87-42.259-23.728-2.298-3.773-1.103-8.696 2.671-10.994 3.773-2.299 8.695-1.103 10.994 2.671 6.122 10.051 16.811 16.051 28.594 16.051 45.637-.002 82.573 36.93 82.573 82.571zm-139.606-80.193c.941 4.317-1.796 8.579-6.113 9.52-21.054 4.587-42.467-.005-59.516-11.642-16.878 18.087-39.176 15.744-36.191 15.744-36.795-.001-66.573 29.773-66.573 66.571v47.257c0 4.418-3.582 8-8 8s-8-3.582-8-8v-47.257c0-45.636 36.929-82.571 82.571-82.571 18.462 0 33.429-14.875 33.429-33.342v-2.107c-34.919-16.697-59.429-51.784-60.923-92.643-14.37-3.455-25.077-16.317-25.077-31.62v-41.473c-.437-20.3 2.577-71.143 39.648-106.877 45.775-44.126 119.183-41.323 173.161-15.338 5.261 2.535 6.06 9.643 1.691 13.324 27.345 6.67 50.925 23.48 66.074 47.538.782 1.239 2.214 3.184 1.84 6.287-.232 1.931-.807 3.565-2.295 5.075-9.75 9.888-15.119 22.991-15.119 36.896v54.57c0 4.418-3.582 8-8 8s-8-3.582-8-8v-54.57c0-16.037 5.479-31.259 15.542-43.487-15.338-21.936-39.268-36.044-66.332-38.942l-14.061-1.506c-8.222-.88-9.835-12.207-2.194-15.352l6.395-2.633c-83.286-29.035-172.351 3.226-172.351 114.928v41.56c0 6.348 3.656 11.865 9 14.636v-51.863c0-30.878 25.122-56 56-56h102c30.878 0 56 25.12 56 55.997v65.503c0 69.574-67.988 122.42-137.17 102.053-.45 5.708-1.871 11.216-4.186 16.336 13.458 9.242 30.453 12.97 47.23 9.314 4.317-.94 8.579 1.797 9.52 6.114zm-22.394-43.425c50.178 0 91-40.822 91-91v-64.895c0-22.054-17.944-39.997-40-39.997h-102c-22.056 0-40 17.944-40 40v64.892c0 50.178 40.822 91 91 91zm81 137.875h-24c-4.418 0-8 3.582-8 8s3.582 8 8 8h24c4.418 0 8-3.582 8-8s-3.582-8-8-8z"></path></svg>                                <div class="todo-description">
                                        <h3 class="todo-header" data-translate-text="LB_SIGNUP_CUSTOMIZE_PROFILE"><?php echo e(__('web.LB_SIGNUP_CUSTOMIZE_PROFILE')); ?></h3>
                                        <p class="todo-text" data-translate-text="LB_SIGNUP_CUSTOMIZE_PROFILE_SUBTEXT"><?php echo e(__('web.LB_SIGNUP_CUSTOMIZE_PROFILE_SUBTEXT')); ?></p>
                                    </div>
                                    <a class="btn btn-secondary edit-profile" data-translate-text="EDIT_PROFILE"><?php echo e(__('web.EDIT_PROFILE')); ?></a>
                                </div>
                                <div class="complete-todo">
                                    <svg class="todo-icon popular" id="Capa_1" enable-background="new 0 0 512 512" height="512" viewBox="0 0 512 512" width="512" xmlns="http://www.w3.org/2000/svg"><g id="XMLID_1159_"><g id="XMLID_2123_"><path id="XMLID_2121_" d="m189.412 153.557 40.002-124.408c8.199-25.5 44.263-25.544 52.524-.063l40.355 124.471h131.388c26.747 0 37.854 34.238 16.2 49.939l-106.078 76.914 40.723 124.129c8.347 25.442-20.787 46.669-42.447 30.926l-105.675-76.807-106.049 77.265c-21.632 15.761-50.782-5.408-42.49-30.855l40.653-124.755-106.354-76.784c-21.709-15.673-10.622-49.972 16.154-49.972z" fill="#ffcd69"></path><g id="XMLID_2119_"><path id="XMLID_871_" d="m134.105 451.353c-7.69 0-15.38-2.436-22.093-7.311-13.442-9.762-18.803-26.275-13.655-42.071l38.393-117.818-100.44-72.516c-13.475-9.729-18.878-26.233-13.766-42.047s19.154-26.032 35.774-26.032h123.805l37.772-117.47c5.089-15.827 19.121-26.067 35.747-26.088h.049c16.604 0 30.638 10.201 35.761 26.002l38.112 117.556h13.423c5.523 0 10 4.478 10 10s-4.477 10-10 10h-20.694c-4.334 0-8.176-2.793-9.513-6.916l-40.354-124.472c-2.909-8.974-10.55-12.17-16.739-12.17-.007 0-.014 0-.021 0-6.193.008-13.84 3.219-16.731 12.21l-40.003 124.409c-1.33 4.135-5.176 6.939-9.52 6.939h-131.094c-9.441 0-14.84 6.294-16.744 12.184-1.904 5.891-1.211 14.153 6.443 19.681l106.354 76.785c3.524 2.544 5.001 7.073 3.654 11.206l-40.653 124.755c-2.924 8.973 1.384 16.055 6.392 19.69 5.007 3.636 13.076 5.54 20.702-.016l106.049-77.266c3.505-2.555 8.259-2.559 11.768-.007l105.675 76.807c7.637 5.55 15.704 3.633 20.708-.012 5.003-3.646 9.301-10.737 6.358-19.708l-40.723-124.13c-1.354-4.13.113-8.662 3.632-11.213l106.078-76.914c7.635-5.536 8.317-13.794 6.409-19.676s-7.307-12.167-16.738-12.167h-20.694c-5.523 0-10-4.478-10-10s4.477-10 10-10h20.694c16.602 0 30.64 10.204 35.762 25.996 5.123 15.792-.252 32.293-13.693 42.038l-100.172 72.632 38.449 117.199c5.181 15.792-.151 32.32-13.584 42.107-13.432 9.786-30.799 9.797-44.244.024l-99.789-72.528-100.167 72.98c-6.722 4.899-14.43 7.348-22.139 7.348z"></path></g><g id="XMLID_2151_"><path id="XMLID_856_" d="m256 512c-5.523 0-10-4.478-10-10v-80.877c0-5.522 4.477-10 10-10s10 4.478 10 10v80.877c0 5.522-4.477 10-10 10z"></path></g><g id="XMLID_2150_"><path id="XMLID_855_" d="m499.933 334.776c-1.024 0-2.065-.159-3.092-.492l-76.918-24.992c-5.252-1.707-8.127-7.349-6.42-12.601 1.706-5.252 7.348-8.123 12.601-6.421l76.918 24.992c5.252 1.707 8.127 7.349 6.42 12.601-1.374 4.226-5.294 6.913-9.509 6.913z"></path></g><g id="XMLID_2152_"><path id="XMLID_854_" d="m359.211 113.447c-2.038 0-4.094-.621-5.87-1.911-4.468-3.246-5.458-9.5-2.212-13.968l47.538-65.431c3.247-4.468 9.499-5.459 13.968-2.212 4.468 3.246 5.458 9.5 2.212 13.968l-47.538 65.431c-1.956 2.694-5.006 4.123-8.098 4.123z"></path></g><g id="XMLID_2154_"><path id="XMLID_853_" d="m152.789 113.447c-3.093 0-6.142-1.43-8.099-4.123l-47.538-65.43c-3.246-4.468-2.255-10.722 2.212-13.968 4.469-3.248 10.722-2.256 13.968 2.212l47.538 65.431c3.246 4.468 2.255 10.722-2.212 13.968-1.774 1.289-3.831 1.91-5.869 1.91z"></path></g><g id="XMLID_2156_"><path id="XMLID_852_" d="m12.067 334.776c-4.216 0-8.135-2.687-9.509-6.913-1.706-5.252 1.168-10.894 6.42-12.601l76.918-24.992c5.254-1.706 10.894 1.168 12.601 6.421 1.707 5.252-1.168 10.894-6.42 12.601l-76.917 24.992c-1.027.333-2.069.492-3.093.492z"></path></g></g><g id="XMLID_1847_"><g id="XMLID_1848_"><path id="XMLID_851_" d="m387.99 163.56c-2.63 0-5.21-1.069-7.07-2.93-1.86-1.86-2.93-4.44-2.93-7.07s1.07-5.21 2.93-7.069c1.86-1.86 4.43-2.931 7.07-2.931 2.63 0 5.21 1.07 7.07 2.931 1.86 1.859 2.93 4.439 2.93 7.069s-1.07 5.21-2.93 7.07-4.44 2.93-7.07 2.93z"></path></g></g></g></svg>                                <div class="todo-description">
                                        <h3 class="todo-header" data-translate-text="LB_SIGNUP_ENJOY_POPULAR"><?php echo e(__('web.LB_SIGNUP_ENJOY_POPULAR')); ?></h3>
                                        <p class="todo-text" data-translate-text="LB_SIGNUP_ENJOY_POPULAR_SUBTEXT"><?php echo e(__('web.LB_SIGNUP_ENJOY_POPULAR_SUBTEXT')); ?></p>
                                    </div>
                                    <a href="<?php echo e(route('frontend.trending')); ?>" class="btn btn-secondary popular-page" data-translate-text="VIEW_POPULAR_PAGE"><?php echo e(__('web.VIEW_POPULAR_PAGE')); ?></a>
                                </div>
                                <div class="complete-todo">
                                    ...
                                    <div class="todo-description">
                                        <h3 class="todo-header" data-translate-text="LB_SIGNUP_MAKE_MUSIC"><?php echo e(__('web.LB_SIGNUP_MAKE_MUSIC')); ?></h3>
                                        <p class="todo-text" data-translate-text="LB_SIGNUP_MAKE_MUSIC_SUBTEXT"><?php echo e(__('web.LB_SIGNUP_MAKE_MUSIC_SUBTEXT')); ?></p>
                                    </div>
                                    <a class="btn btn-secondary create-artist" data-translate-text="CLAIM_ARTIST"><?php echo e(__('web.CLAIM_ARTIST')); ?></a>
                                </div>
                            </div>
                        <?php endif; ?>
                    </div>
                ...
                <?php if(! config('settings.disable_register')): ?>
                    <div class="lightbox-footer">
                        <div class="right">
                            <a class="btn btn-primary close hide" data-translate-text="CLOSE"><?php echo e(__('web.CLOSE')); ?></a>
                            <button class="btn btn-primary" type="submit" data-translate-text="SIGN_UP"><?php echo e(__('web.SIGN_UP')); ?></button>
                        </div>
                        <div class="left"></div>
                    </div>
                <?php endif; ?>
    ...
    <div class="lightbox lightbox-forget hide">
        <div class="lbcontainer">
            <form id="forgot-form" class="ajax-form" method="post" action="<?php echo e(route('frontend.account.send.request.reset.password')); ?>">
                <div class="lightbox-header">
                    <h2 class="title" data-translate-text="LB_FORGET_TITLE"><?php echo e(__('web.LB_FORGET_TITLE')); ?></h2>
                    <?php echo $__env->yieldContent('lightbox-close'); ?>
                </div>
                <div class="lightbox-content">
                    <div class="lightbox-content-block">
                        ...
                        <p data-translate-text="LB_FORGET_SUBTITLE"><?php echo e(__('web.LB_FORGET_SUBTITLE')); ?></p>
                        <div class="control-group">
                            <label class="control-label" for="username" data-translate-text="LB_FORGET_USERNAME"><?php echo e(__('web.LB_FORGET_USERNAME')); ?></label>
                ...
                <div class="lightbox-footer">
                    <div class="left-btns"><a class="btn btn-secondary close" data-translate-text="CANCEL"><?php echo e(__('web.CANCEL')); ?></a></div>
                    <div class="right-btns"><button type="submit" class="btn btn-primary" data-translate-text="SUBMIT"><?php echo e(__('web.SUBMIT')); ?></button></div>
                </div>
            </form>
        </div>
    </div>
    <div class="lightbox lightbox-createPlaylist hide">
        <div class="lbcontainer">
            <div id="create-playlist">
                <form id="create-playlist-form" method="post" action="<?php echo e(route('frontend.auth.user.create.playlist')); ?>" enctype="multipart/form-data" novalidate>
                    <div class="lightbox-header">
                        <h2 class="title" data-translate-text="POPUP_PLAYLIST_METADATA_CREATE_NEW"><?php echo e(__('web.POPUP_PLAYLIST_METADATA_CREATE_NEW')); ?></h2>
                        <?php echo $__env->yieldContent('lightbox-close'); ?>
                    </div>
                    <div class="lightbox-content">
                        <div class="lightbox-content-block">
                            ...
                            <div class="lightbox-with-artwork-block">
                                <div class="img-container">
                                    <img class="img" src="<?php echo e(asset('common/default/playlist.png')); ?>"/>
                                    <div class="artwork-select">
                                        <span><?php echo e(__('web.EDIT')); ?></span>
                    ...
                    <div class="lightbox-footer">
                        <div class="right">
                            <button class="btn btn-primary" type="submit" data-translate-text="POPUP_PLAYLIST_METADATA_CREATE"><?php echo e(__('web.POPUP_PLAYLIST_METADATA_CREATE')); ?></button>
                        </div>
                        <div class="left">
                            <div class="row ml-0 mr-0 mt-2">
                                ...
                                <label class="lbl" for="create-playlist-checkbox"><?php echo e(__('web.MAKE_PUBLIC')); ?></label>
                            </div>
                        </div>
                    </div>
                </form>
    ...
    <div class="lightbox lightbox-rename hide">
        <div class="lbcontainer">
            <form id="edit-playlist-form" class="ajax-form" method="post" action="<?php echo e(route('frontend.auth.user.playlist.edit')); ?>" novalidate>
                <div class="lightbox-header">
                    <h2 class="title" data-translate-text="POPUP_PLAYLIST_META_TITLE"><?php echo e(__('web.POPUP_PLAYLIST_META_TITLE')); ?></h2>
                    <?php echo $__env->yieldContent('lightbox-close'); ?>
                </div>
                <div class="lightbox-content">
                    <div class="lightbox-content-block">
                        ...
                        <div class="lightbox-with-artwork-block">
                            ...
                            <div class="input-container">
                                <div class="control field">
                                    <label for="name">
                                        <span data-translate-text="NAME"><?php echo e(__('web.NAME')); ?></span>
                                    </label>
                                ...
                                <div class="control field">
                                    <label for="description">
                                        <span data-translate-text="GENRES"><?php echo e(__('web.GENRES')); ?></span>
                                    </label>
                                    <select class="select2" name="genre[]" placeholder="Select genres" multiple autocomplete="off">
                                    </select>
                                </div>
                                <div class="control field">
                                    <label for="description">
                                        <span data-translate-text="MOODS"><?php echo e(__('web.MOODS')); ?></span>
                                    </label>
                                    <select class="select2" name="mood[]" placeholder="Select moods" multiple autocomplete="off">
                                    </select>
                                </div>
                                <div class="control field">
                                    <label for="description">
                                        <span data-translate-text="DESCRIPTION"><?php echo e(__('web.DESCRIPTION')); ?></span>
                                    </label>
                                    <textarea type="text" name="description" maxlength="180"></textarea>
                                </div>
                            </div>
                ...
                <div class="lightbox-footer">
                    <div class="right">
                        <button class="btn btn-primary" type="submit" data-translate-text="SAVE_CHANGES"><?php echo e(__('web.SAVE_CHANGES')); ?></button>
                    </div>
                    <div class="left">
                        <div class="row ml-0 mr-0 mt-2">
                            ...
                            <label class="lbl" for="edit-playlist-checkbox"><?php echo e(__('web.MAKE_PUBLIC')); ?></label>
                        </div>
                    </div>
                </div>
            </form>
                ...
                <form class="ajax-form" method="post" action="/more.php?do=playlist&action=deletePlaylist" novalidate>
                    ...
                    <div class="lightbox-content">
                        <div class="lightbox-content-block">
                            ...
                            <p data-translate-text="POPUP_DELETE_PLAYLIST_MESSAGE"><?php echo e(__('web.POPUP_DELETE_PLAYLIST_MESSAGE')); ?></p>
                            <input name="id" type="hidden">
                        </div>
                    </div>
                    <div class="lightbox-footer">
                        <div class="right"><button class="btn btn-primary" type="submit" data-translate-text="DELETE"><?php echo e(__('web.DELETE')); ?></button></div>
                        <div class="left"><a class="btn btn-secondary close" data-translate-text="CANCEL"><?php echo e(__('web.CANCEL')); ?></a></div>
                    </div>
                </form>
            </div>
        </div>
            ...
            <form id="share-lightbox">
                <div class="lightbox-header lightbox-nav-container">
                    <ul class="lightbox-nav">
                        <li id="share-embed" class="share-svc active pl-3 pr-3" data-share-svc="embed" data-translate-text="LB_SITE_PLAYER"><?php echo e(__('web.LB_SHARE_EMBED')); ?></li>
                        ...
                        <li id="share-more" class="share-svc pl-3 pr-3" data-share-svc="more" data-translate-text="MORE"><?php echo e(__('web.MORE')); ?></li>
                    </ul>
                    <?php echo $__env->yieldContent('lightbox-close'); ?>
                </div>
                <div class="lightbox-content">
                    ...
                    <div class="lightbox-content-block">
                        ...
                        <div id="share-svc">
                            ...
                            <div class="svc-box facebook hide">
                                <p class="mb-0" data-translate-text="LB_SHARE_FACEBOOK_MSG"><?php echo __('web.LB_SHARE_FACEBOOK_MSG'); ?></p>
                            </div>
                            <div class="svc-box twitter hide">
                                <p class="label" data-translate-text="BROADCAST_TWEET"><?php echo e(__('web.BROADCAST_TWEET')); ?></p><textarea id="share-message-tw"></textarea><span id="twitter-char-count" class="">45</span>
                            </div>
                            <div class="svc-box more hide">
                                <p data-translate-text="LB_SHARE_MORE_MSG"><?php echo e(__('web.LB_SHARE_MORE_MSG')); ?></p>
                                <div class="share-more-option reddit">
                                    ...
                                    <a target="_blank" class="btn btn-secondary" data-translate-text="SHARE"><?php echo e(__('web.SHARE')); ?></a>
                                </div>
                ...
                <div class="lightbox-footer">
                    <div id="share-link">
                        ...
                        <div class="copy-background">
                            <a class="btn" id="share-lightbox-copy" data-translate-text="SHARE_COPY"><?php echo e(__('web.SHARE_COPY')); ?></a>
                        </div>
                    </div>
                    <div class="right-btns">
                        <a class="btn btn-primary submit" data-translate-text="SHARE"><?php echo e(__('web.SHARE')); ?></a>
                    </div>
                </div>
            </form>
        </div>
    ...
    <div class="lightbox lightbox-feedback hide">
        <div class="lbcontainer">
            <form id="feedback-form" class="ajax-form" method="post" action="<?php echo e(route('frontend.feedback')); ?>">
                <div class="lightbox-header">
                ...
                <div class="lightbox-content">
                    <div class="lightbox-content-block">
                        <div class="error hide"></div>
                        <p data-translate-text="LB_FEEDBACK_MSG"><?php echo e(__('web.LB_FEEDBACK_MSG')); ?></p>
                        <div class="field">
                            <label for="email" class="label" data-translate-text="LB_FEEDBACK_EMAIL"><?php echo e(__('web.LB_FEEDBACK_EMAIL')); ?></label>
                            <input id="email" name="email" value="<?php echo e(auth()->check() ? auth()->user()->email : ''); ?>" type="text">
                        </div>
                        <div class="field"><label for="feedback_feeling" class="label" data-translate-text="LB_FEEDBACK_FEELING"><?php echo e(__('web.LB_FEEDBACK_FEELING')); ?></label><select id="feedback_feeling" class="feeling select2" name="feeling"><option value="">—</option><option>Angry</option><option>Confused</option><option>Happy</option><option>Amused</option><option>Impressed</option><option>Surprised</option><option>Disappointed</option><option>Frustrated</option><option>Curious</option><option>Indifferent</option></select></div>
                        <div class="field"><label for="feedback_about" class="label" data-translate-text="LB_FEEDBACK_ABOUT"><?php echo e(__('web.LB_FEEDBACK_ABOUT')); ?></label><select id="feedback_about" class="about select2" name="about"><option value="">—</option><option value="Website">Website</option><option value="General">General Question</option><optgroup label="Mobile Devices"><option>iPhone</option><option>Android</option></optgroup></select></div>
                        <div class="field"><label for="comment" class="label" data-translate-text="LB_FEEDBACK_REPORT"><?php echo e(__('web.LB_FEEDBACK_REPORT')); ?></label>
                ...
                <div class="lightbox-footer">
                    <div class="right">
                        <button class="btn btn-primary submit" data-translate-text="SUBMIT" type="submit"><?php echo e(__('web.SUBMIT')); ?></button>
                    </div>
                </div>
            </form>
        </div>
        ...
        <div class="lbcontainer">
            <div class="lightbox-header">
                <ul class="lightbox-nav lightbox-nav-container nav nav-tabs" role="tablist">
                    ...
                    <?php endif; ?>
                    <?php if(config('settings.payment_paypal')): ?>
                        <li class="nav-item lightbox-tab">
                    ...
                    <?php endif; ?>
                    <?php if(is_array(config('payment.gateway'))): ?>
                        <?php $__currentLoopData = config('payment.gateway'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $gateway): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <li class="nav-item lightbox-tab">
                                <button class="nav-link" data-toggle="tab" href="#<?php echo e(str_slug($gateway['name'])); ?>-payment" role="tab" aria-controls="<?php echo e(str_slug($gateway['name'])); ?>-payment" aria-selected="false"><?php echo e($gateway['name']); ?></button>
                            </li>
            ...
            <div class="lightbox-content">
                ...
                <div class="lightbox-content-block">
                    ...
                    <div id="confirm-container" class="control-group">
                        <div class="header">
                            <p class="description" data-translate-text="DESCRIPTION"><?php echo e(__('web.FORM_DESCRIPTION')); ?></p>
                            <p class="price" data-translate-text="AMOUNT"><?php echo e(__('web.FORM_AMOUNT')); ?></p>
                        </div>
                        <div class="product">
                        ...
                        <div class="total">
                            <p class="description"><?php echo e(__('web.FORM_TOTAL')); ?></p>
                            <p class="price"></p>
                        </div>
                    </div>
                    <p class="security-reassurance text-center"><?php echo e(__('web.PAYMENT_SECURITY_TITLE')); ?></p>
                    <p class="text-secondary small mt-5"><?php echo e(__('web.PAYMENT_SECURITY_DESC')); ?></p>
                    ...
                    <div class="tab-content">
                        <?php if(config('settings.payment_stripe')): ?>
                            <div class="control-group tab-pane fade" id="stripe-payment" role="tabpanel" aria-labelledby="stripe-payment-tab">
                                <form id="payment-form" method="post">
                                    <div class="form-row">
                                        <label for="card-element" class="card-element-helper">
                                            <?php echo e(__('web.PAYMENT_STRIPE_TIP')); ?>
                                ...
                                <form id="stripe-form" class="ajax-form stripe-local-form" method="post" action="<?php echo e(route('frontend.stripe.subscription')); ?>">
                                ...
                                <div class="d-flex justify-content-center align-items-center mt-3">
                                    <button id="stripe-form-submit-button" class="btn btn-primary">
                                        <span><?php echo e(__('web.SUBMIT_PAYMENT')); ?></span>
                                    </button>
                                </div>
                            </div>
                        <?php endif; ?>
                        <?php if(config('settings.payment_paypal')): ?>
                            <div class="control-group tab-pane fade" id="paypal-payment" role="tabpanel" aria-labelledby="paypal-payment-tab">
                                <p class="text-center" data-translate-text="OPEN_PAYPAL_CTA"><?php echo e(__('web.PAYMENT_PAYPAL_TIP')); ?></p>
                                <div class="row justify-content-center align-items-center">
                                    <a class="paypal-open btn btn-secondary btn-paypal mt-3" target="_blank" data-translate-text="OPEN_PAYPAL">
                        ...
                        <?php if(is_array(config('payment.gateway'))): ?>
                            <?php $__currentLoopData = config('payment.gateway'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $gateway): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="control-group tab-pane fade" id="<?php echo e(str_slug($gateway['name'])); ?>-payment" role="tabpanel" aria-labelledby="<?php echo e(str_slug($gateway['name'])); ?>-payment-tab">
                                    <p class="text-center"><?php echo e(__('web.PAYMENT_GATEWAY_TIP', ['name' => $gateway['name']])); ?></p>
                                    <div class="row justify-content-center align-items-center">
                                        <a class="btn btn-payment mt-3" style="background: <?php echo e($gateway['buttonColor']); ?>" data-purchase-uri="<?php echo e($gateway['purchaseLink']); ?>" data-subscription-uri="<?php echo e($gateway['subscriptionLink']); ?>" target="_blank">
                                            <?php echo $gateway['buttonIcon']; ?>

                                            <span>Pay by <?php echo e($gateway['name']); ?></span>
                                        </a>
                                    </div>
                                </div>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        ...
        <div class="lbcontainer">
            <form id="feedback-lightbox">
                ...
                <div class="lightbox-content">
                    <div class="lightbox-content-block">
                        <div class="error hide"></div>
                        <p data-translate-text="LB_BILLING_FEEDBACK_MSG"><?php echo e(__('web.LB_BILLING_FEEDBACK_MSG')); ?></p>
                        <div class="field">
                            <label for="email" class="label" data-translate-text="LB_FEEDBACK_EMAIL"><?php echo e(__('web.LB_FEEDBACK_EMAIL')); ?></label>
                            <input type="text" name="email" value=""></div>
                        <div class="field">
                            <label for="feedback" class="label" data-translate-text="LB_BILLING_FEEDBACK_REPORT"><?php echo e(__('web.LB_BILLING_FEEDBACK_REPORT')); ?></label>
                            <div class="textarea_wrapper clear">
                                <div class="top">
                                    <div class="cap"></div>
                                </div>
                ...
                <div class="lightbox-footer">
                    <div class="right"><a class="btn btn-primary submit" data-translate-text="SUBMIT"><?php echo e(__('web.SUBMIT')); ?></a></div>
                    <div class="left"></div>
                </div>
                ...
                <div class="lightbox-content">
                    ...
                    <div class="lightbox-content-block">
                        ...
                        <div id="friends-can-collaborate">
                            <p class="invite-collaborate-loading" data-translate-text="PLEASE_WAIT"><?php echo e(__('web.PLEASE_WAIT')); ?></p>
                            <div class="invite-to-collaborate hide">
                                <div class="img-container">
                                    <img class="img"/>
                                </div>
                                <span class="title"></span>
                                <a class="btn btn-primary invite-friend align-self-center" data-translate-text="INVITE"><?php echo e(__('web.INVITE')); ?></a>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="lightbox lightbox-locale hide">
        <div class="lbcontainer">
            <div id="choose-locale">
                <div class="lightbox-header">
                    <h2 class="title" data-translate-text="LANGUAGE"><?php echo e(__('web.LANGUAGE')); ?></h2>
                    <?php echo $__env->yieldContent('lightbox-close'); ?>
                </div>
                <div class="lightbox-content">
                    <div class="lightbox-content-block  separated-content">
                        <ul class="languages row">
                            <?php if(Cache::has('languages')): ?>
                                <?php $__currentLoopData = Cache::get('languages'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $code => $language): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <li class="language col-4"><a class="<?php if($code == \Session::get('website_language', config('app.locale'))): ?> active <?php endif; ?>" rel="<?php echo e($code); ?>"><?php echo e($language); ?></a></li>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            <?php endif; ?>
                        </ul>
                ...
                <div class="lightbox-footer">
                    <div class="right"></div>
                    <div class="left"><a class="btn btn-secondary close" data-translate-text="CLOSE"><?php echo e(__('web.CLOSE')); ?></a></div>
                </div>
            </div>
        </div>
    </div>
    <div class="lightbox lightbox-edit-song hide">
        <form id="edit-song-form" class="ajax-form" method="post" action="<?php echo e(route('frontend.auth.user.artist.manager.song.edit.post')); ?>" enctype="multipart/form-data" novalidate>
            <div class="lbcontainer">
                <div id="upload-song">
                    <div class="lightbox-header">
                        <h2 class="title"></h2>
                    ...
                    <div class="lightbox-content">
                        <div class="lightbox-content-block">
                            ...
                            <div class="song-info-container">
                                ...
                                <div class="control field">
                                    <label for="description">
                                        <span data-translate-text="FORM_DESCRIPTION"><?php echo e(__('FORM_DESCRIPTION')); ?></span>
                                    </label>
                                    <textarea type="text" name="description" maxlength="180"></textarea>
                                </div>
                                <div class="control field">
                                    <label for="name">
                                        <span data-translate-text="FORM_RELEASED_AT"><?php echo e(__('FORM_RELEASED_AT')); ?></span>
                                    </label>
                                    <input class="datepicker" name="released_at" type="text" placeholder="None" autocomplete="off">
                                </div>
                                <div class="control field">
                                    <label for="name">
                                        <span data-translate-text="FORM_COPYRIGHT"><?php echo e(__('FORM_COPYRIGHT')); ?></span>
                                    </label>
                                ...
                                <div class="control field mb-0">
                                    <div class="row ml-0 mr-0 mt-2 explicit-check-box">
                                        ...
                                        <label class="lbl" for="edit-song-explicit"><?php echo e(__('web.SONG_EXPLICIT')); ?></label>
                                    </div>
                                </div>
                                <div class="control field mb-0">
                                    <div class="row">
                                        <div class="col-6">
                                            <div class="row ml-0 mr-0 mt-2 visibility-check-box">
                                                ...
                                                <label class="lbl" for="edit-song-visibility"><?php echo e(__('web.MAKE_PUBLIC')); ?></label>
                                            </div>
                                        </div>
                                        <div class="col-6">
                                            <div class="row ml-0 mr-0 mt-2 comments-check-box">
                                                ...
                                                <label class="lbl" for="edit-song-comments"><?php echo e(__('web.ALLOW_COMMENTS')); ?></label>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-6">
                                            <div class="row ml-0 mr-0 mt-2 downloadable-check-box">
                                                ...
                                                <label class="lbl" for="edit-song-downloadable"><?php echo e(__('web.ALLOW_DOWNLOAD')); ?></label>
                                            </div>
                                        </div>
                                        <div class="col-6">
                                            <div class="row ml-0 mr-0 mt-2 selling-check-box" data-toggle="collapse" href="#edit-song-collapse-id" role="button" aria-expanded="false" aria-controls="edit-song-collapse-id">
                                                ...
                                                <label class="lbl" for="edit-song-selling"><?php echo e(__('web.SELL_THIS_SONG')); ?></label>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="control field collapse" id="edit-song-collapse-id">
                                    <label for="created_at">
                                        <span data-translate-text="FORM_PRICE"><?php echo e(__('web.FORM_PRICE')); ?> </span>
                                    </label>
                                    <input name="price" type="number" step="1" min="<?php echo e(\App\Models\Role::getValue('monetization_song_min_price')); ?>" max="<?php echo e(\App\Models\Role::getValue('monetization_song_max_price')); ?>" placeholder="<?php echo e(__('web.SELL_THIS_SONG_TIP')); ?>" autocomplete="off">
                                </div>
                            </div>
                            <input name="id" type="hidden">
    ...
    <div class="lightbox lightbox-create-album hide">
        <div class="lbcontainer">
            <div id="create-playlist">
                <form id="create-album-form" class="ajax-form" method="post" action="<?php echo e(route('frontend.auth.user.artist.manager.albums.create')); ?>" enctype="multipart/form-data" novalidate>
                    <div class="lightbox-header">
                        <h2 class="title" data-translate-text="POPUP_ALBUM_METADATA_CREATE_NEW"><?php echo e(__('web.POPUP_ALBUM_METADATA_CREATE_NEW')); ?></h2>
                        <?php echo $__env->yieldContent('lightbox-close'); ?>
                    </div>
                    <div class="lightbox-content">
                        <div class="lightbox-content-block">
                            ...
                            <div class="lightbox-with-artwork-block">
                                <div class="img-container">
                                    <img class="img" src="<?php echo e(asset('common/default/album.png')); ?>" data-default-artwork="<?php echo e(asset('artworks/defaults/album.png')); ?>"/>
                                ...
                                <div class="input-container">
                                    <div class="control field">
                                        <label for="title">
                                            <span data-translate-text="FORM_TITLE"><?php echo e(__('FORM_TITLE')); ?></span>
                                        </label>
                                        <input name="title" type="text" required>
                                    </div>
                                    <div class="control field">
                                        <label for="description">
                                            <span data-translate-text="<?php echo e(__('FORM_GENRE')); ?>"><?php echo e(__('FORM_GENRE')); ?></span>
                                        </label>
                                        <select class="select2" name="genre[]" placeholder="Select genres" multiple autocomplete="off">
                                        </select>
                                    </div>
                                    <div class="control field">
                                        <label for="description">
                                            <span data-translate-text="FORM_MOOD"><?php echo e(__('FORM_MOOD')); ?></span>
                                        </label>
                                        <select class="select2" name="mood[]" placeholder="Select moods" multiple autocomplete="off">
                                        </select>
                                    </div>
                                    <div class="control field">
                                        <label for="type">
                                            <span data-translate-text="FORM_TYPE"><?php echo e(__('web.FORM_TYPE')); ?></span>
                                        </label>
                                        <?php echo makeDropDown(array(
                                    ...
                                    <div class="control field">
                                        <label for="created_at">
                                            <span data-translate-text="FORM_SCHEDULE_PUBLISH"><?php echo e(__('FORM_SCHEDULE_PUBLISH')); ?></span>
                                        </label>
                                        ...
                                        <div class="row">
                                            <div class="col-6">
                                                <div class="row ml-0 mr-0 mt-2">
                                                    ...
                                                    <label class="lbl" for="create-album-visibility"><?php echo e(__('web.MAKE_PUBLIC')); ?></label>
                                                </div>
                                            </div>
                                            <div class="col-6">
                                                <div class="row ml-0 mr-0 mt-2">
                                                    ...
                                                    <label class="lbl" for="create-album-comments"><?php echo e(__('web.ALLOW_COMMENTS')); ?></label>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="row">
                                            <div class="col-12">
                                                <div class="row ml-0 mr-0 mt-2" data-toggle="collapse" href="#create-album-collapse-id" role="button" aria-expanded="false" aria-controls="create-album-collapse-id">
                                                    ...
                                                    <label class="lbl" for="create-album-selling"><?php echo e(__('web.SELL_THIS_ALBUM')); ?></label>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="control field collapse" id="create-album-collapse-id">
                                        ...
                                        <input name="price" type="number" step="1" min="<?php echo e(\App\Models\Role::getValue('monetization_album_min_price')); ?>" max="<?php echo e(\App\Models\Role::getValue('monetization_album_max_price')); ?>" placeholder="<?php echo e(__('web.SELL_THIS_SONG_TIP')); ?>" autocomplete="off">
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="lightbox-footer">
                        <div class="right">
                            <button class="btn btn-primary" type="submit" data-translate-text="POPUP_ALBUM_METADATA_CREATE"><?php echo e(__('web.POPUP_ALBUM_METADATA_CREATE')); ?></button>
                        </div>
                    </div>
                </form>
            </div>
    ...
    <div class="lightbox lightbox-edit-album hide">
        <div class="lbcontainer">
            <div id="create-playlist">
                <form id="edit-album-form" class="ajax-form" method="post" action="<?php echo e(route('frontend.auth.user.artist.manager.albums.edit')); ?>" enctype="multipart/form-data" novalidate>
                    <div class="lightbox-header">
                        <h2 class="title"></h2>
                        <?php echo $__env->yieldContent('lightbox-close'); ?>
                    </div>
                                        ...
                                        <div class="row">
                                            <div class="col-6">
                                                <div class="row ml-0 mr-0 mt-2">
                                                    ...
                                                    <label class="lbl" for="edit-album-visibility"><?php echo e(__('web.MAKE_PUBLIC')); ?></label>
                                                </div>
                                            </div>
                                            <div class="col-6">
                                                <div class="row ml-0 mr-0 mt-2">
                                                    ...
                                                    <label class="lbl" for="edit-album-comments"><?php echo e(__('web.ALLOW_COMMENTS')); ?></label>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="row">
                                            <div class="col-12">
                                                <div class="row ml-0 mr-0 mt-2" data-toggle="collapse" href="#edit-album-collapse-id" role="button" aria-expanded="false" aria-controls="edit-album-collapse-id">
                                                    ...
                                                    <label class="lbl" for="edit-album-selling"><?php echo e(__('web.SELL_THIS_ALBUM')); ?></label>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div class="lightbox-footer">
                        <div class="right">
                            <button class="btn btn-primary" type="submit" data-translate-text="SAVE"><?php echo e(__('web.SAVE')); ?></button>
                        </div>
                    </div>
                </form>
            </div>
    ...
    <div class="lightbox lightbox-create-event hide">
        <div class="lbcontainer">
            <form id="create-event-form" class="ajax-form" method="post" action="<?php echo e(route('frontend.auth.user.artist.manager.event.create')); ?>" enctype="multipart/form-data" novalidate>
                <div class="lightbox-header">
                    <h2 class="title"><?php echo e(__('web.CREATE_EVENT')); ?></h2>
                    <?php echo $__env->yieldContent('lightbox-close'); ?>
                </div>
                <div class="lightbox-content">
                    <div class="lightbox-content-block">
                        ...
                        <div class="control field">
                            <label for="title">
                                <span data-translate-text="FORM_TITLE"><?php echo e(__('web.FORM_TITLE')); ?></span>
                            </label>
                            <input name="title" type="text" required>
                        </div>
                        <div class="control field">
                            <label for="location">
                                <span data-translate-text="<?php echo e(__('web.FORM_LOCATION')); ?>"><?php echo e(__('web.FORM_LOCATION')); ?></span>
                            </label>
                            <input name="location" type="text" required>
                        </div>
                        <div class="control field">
                            <label for="link">
                                <span data-translate-text="FORM_OUTSIDE_LINK"><?php echo e(__('web.FORM_OUTSIDE_LINK')); ?></span>
                            </label>
                            <input name="link" type="text">
                        </div>
                        <div class="control field">
                            <label for="started_at">
                                <span data-translate-text="<?php echo e(__('web.FORM_STARTING_AT')); ?>"><?php echo e(__('web.FORM_STARTING_AT')); ?></span>
                            </label>
                            <input class="datepicker" name="started_at" type="text" placeholder="<?php echo e(__('web.IMMEDIATELY')); ?>" autocomplete="off">
                        </div>
                    </div>
                </div>
                <div class="lightbox-footer">
                    <div class="right">
                        <button class="btn btn-primary" type="submit" data-translate-text="CREATE"><?php echo e(__('web.CREATE')); ?></button>
                    </div>
                </div>
            </form>
        </div>
    ...
    <div class="lightbox lightbox-edit-event hide">
        <div class="lbcontainer">
            <form id="edit-event-form" class="ajax-form" method="post" action="<?php echo e(route('frontend.auth.user.artist.manager.event.edit')); ?>" enctype="multipart/form-data" novalidate>
                <div class="lightbox-header">
                    <h2 class="title"><?php echo e(__('web.EDIT_EVENT')); ?></h2>
                    <?php echo $__env->yieldContent('lightbox-close'); ?>
                </div>
                <div class="lightbox-content">
                    <div class="lightbox-content-block">
                        ...
                        <div class="control field">
                            <label for="location">
                                <span data-translate-text="FORM_LOCATION">><?php echo e(__('web.FORM_LOCATION')); ?></span>
                            </label>
                            <input name="location" type="text" required>
                        </div>
                        <div class="control field">
    ...
    <div class="lightbox lightbox-vipOnlyFeature hide">
        <div class="lbcontainer">
            <div class="lightbox-header">
                <h2 class="title" data-translate-text="LB_VIP_ONLY_TITLE"><?php echo e(__('web.LB_VIP_ONLY_TITLE')); ?></h2>
                <?php echo $__env->yieldContent('lightbox-close'); ?>
            </div>
            <div class="lightbox-content">
                <div class="lightbox-content-block">
                    <h3 data-translate-text="LB_VIP_ONLY_SUBTITLE"><?php echo e(__('web.LB_VIP_ONLY_SUBTITLE')); ?></h3>
                    <p data-translate-text="LB_VIP_ONLY_MSG"><?php echo e(__('web.LB_VIP_ONLY_MSG')); ?></p>
                </div>
            </div>
            <div class="lightbox-footer">
                <div class="left-btns before-login">
                    <a class="btn btn-secondary login" data-translate-text="LOGIN"><?php echo e(__('web.LOGIN')); ?></a>
                </div>
                <div class="right after-login after-login hide">
                    <a class="btn btn-primary" data-translate-text="SUBSCRIBE" href="<?php echo e(route('frontend.settings.subscription')); ?>"><?php echo e(__('web.SUBSCRIBE')); ?></a>
                </div>
            </div>
        </div>
    </div>
    <div class="lightbox lightbox-download hide">
        <div class="lbcontainer">
            <div class="lightbox-header">
                <h2 class="title" data-translate-text="DOWNLOAD"><?php echo e(__('web.DOWNLOAD')); ?></h2>
                <?php echo $__env->yieldContent('lightbox-close'); ?>
            </div>
            <div class="lightbox-content">
                <div class="lightbox-content-block">
                    <div class="download-tip">
                        <h1 data-translate-text="DOWNLOAD_TIP_TITLE"><?php echo e(__('web.DOWNLOAD_TIP_TITLE')); ?></h1>
                        <a class="download-tip-learn" data-translate-text="SUBSCRIBE_NOW"><?php echo e(__('web.SUBSCRIBE')); ?></a>
                    </div>
                    <div class="row">
                        <div class="col-6">
                            <button class="btn btn-block btn-download standard-download">
                                <span data-translate-text="STANDARD"><?php echo e(__('web.STANDARD')); ?></span>
                                <span><?php echo e(config('settings.audio_default_bitrate', 128)); ?> Kbps</span>
                            </button>
                        </div>
                        <div class="col-6">
                            <button class="btn btn-block btn-download hq-download">
                                <span data-translate-text="HIGH_QUALITY"><?php echo e(__('web.HIGH_QUALITY')); ?></span>
                                <span><?php echo e(config('settings.audio_hd_bitrate', 320)); ?> Kbps</span>
                                <label data-translate-text="NOT_AVAILABLE"><?php echo e(__('web.NOT_AVAILABLE')); ?></label>
                                <span class="download-badge bg-danger" data-translate-text="SUBSCRIPTION"><?php echo e(__('web.SUBSCRIPTION')); ?></span>
                            </button>
                        </div>
                    </div>
                </div>
    ...
    <div class="lightbox lightbox-import-postcast-rss hide">
        <div class="lbcontainer">
            <div id="create-playlist">
                <form id="import-podcast-rss-form" class="ajax-form" method="post" action="<?php echo e(route('frontend.auth.user.artist.manager.podcasts.import')); ?>" enctype="multipart/form-data" novalidate>
                    <div class="lightbox-header">
                        <h2 class="title" data-translate-text="ADD_PODCAST_FEED_URL"><?php echo e(__('web.ADD_PODCAST_FEED_URL')); ?></h2>
                        <?php echo $__env->yieldContent('lightbox-close'); ?>
                    </div>
                    <div class="lightbox-content">
                        <div class="lightbox-content-block">
                            ...
                            <div class="control field">
                                <label for="title">
                                    <span data-translate-text="ENTER_PODCAST_FEED_URL"><?php echo e(__('web.ENTER_PODCAST_FEED_URL')); ?></span>
                                </label>
                                <input name="rss_url" type="text" required autocomplete="off">
                            </div>
                            <div class="control field">
                                <label for="description">
                                    <span data-translate-text="<?php echo e(__('FORM_COUNTRY')); ?>"><?php echo e(__('FORM_COUNTRY')); ?></span>
                                </label>
                                <?php echo makeCountryDropDown('country', 'select2 podcast-import-country-select2', null); ?>

                            </div>
                            <div class="control field podcast-import-language-container d-none">
                                <label for="description">
                                    <span data-translate-text="<?php echo e(__('FORM_LANGUAGE')); ?>"><?php echo e(__('FORM_LANGUAGE')); ?></span>
                                </label>
                    ...
                    <div class="lightbox-footer">
                        <div class="right">
                            <button class="btn btn-primary" type="submit" data-translate-text="IMPORT"><?php echo e(__('web.IMPORT')); ?></button>
                        </div>
                        <div class="left">
                            <div class="row ml-0 mr-0 mt-2">
                                ...
                                <label class="lbl" for="import-rss-checkbox" data-translate-text="MAKE_PUBLIC"><?php echo e(__('MAKE_PUBLIC')); ?></label>
                            </div>
                        </div>
                    </div>
                </form>
    ...
    <div class="lightbox lightbox-create-show hide">
        <div class="lbcontainer">
            <form id="create-podcast-show" class="ajax-form" method="post" action="<?php echo e(route('frontend.auth.user.artist.manager.podcasts.create')); ?>" enctype="multipart/form-data" novalidate>
                <div class="lightbox-header">
                    <h2 class="title" data-translate-text="CREATE_NEW_SHOW"><?php echo e(__('web.CREATE_NEW_SHOW')); ?></h2>
                    <?php echo $__env->yieldContent('lightbox-close'); ?>
                </div>
                <div class="lightbox-content">
                    <div class="lightbox-content-block">
                        ...
                        <div class="lightbox-with-artwork-block">
                            <div class="img-container">
                                <img class="img" src="<?php echo e(asset('common/default/podcast.png')); ?>" data-default-artwork="<?php echo e(asset('artworks/defaults/podcast.png')); ?>"/>
                                <div class="control artwork-select">
                                    <span><?php echo e(__('web.EDIT')); ?></span>
                                    <input class="edit-artwork-input" name="artwork" accept="image/*" title="" type="file">
                                </div>
                            ...
                            <div class="input-container">
                                ...
                                <div class="control field">
                                    <label for="description">
                                        <span data-translate-text="<?php echo e(__('FORM_CATEGORY')); ?>"><?php echo e(__('FORM_CATEGORY')); ?></span>
                                    </label>
                                ...
                                <div class="control field row mb-0">
                                    <div class="col-6">
                                        <div class="row ml-0 mr-0 mt-2 visibility-check-box">
                                            ...
                                            <label class="lbl" for="create-podcast-visibility"><?php echo e(__('web.MAKE_PUBLIC')); ?></label>
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <div class="row ml-0 mr-0 mt-2 comments-check-box">
                                            ...
                                            <label class="lbl" for="create-podcast-comments"><?php echo e(__('web.ALLOW_COMMENTS')); ?></label>
                                        </div>
                                    </div>
                                </div>
                                <div class="control field row mb-0">
                                    <div class="col-6">
                                        <div class="row ml-0 mr-0 mt-2 notification-check-box">
                                            ...
                                            <label class="lbl" for="create-podcast-notification"><?php echo e(__('web.NOTIFY_MY_FANS')); ?></label>
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <div class="row ml-0 mr-0 mt-2 notification-check-box">
                                            ...
                                            <label class="lbl" for="create-podcast-downloadable"><?php echo e(__('web.ALLOW_DOWNLOAD')); ?></label>
                                        </div>
                                    </div>
                                </div>
                                <div class="control field row mb-0">
                                    <div class="col-12">
                                        <div class="row ml-0 mr-0 mt-2 notification-check-box">
                                            ...
                                            <label class="lbl" for="create-podcast-explicit" data-translate-text="PODCAST_EXPLICIT"><?php echo e(__('web.PODCAST_EXPLICIT')); ?></label>
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    <div class="lightbox lightbox-edit-show hide">
        <div class="lbcontainer">
            <form id="edit-podcast-show-form" class="ajax-form" method="post" action="<?php echo e(route('frontend.auth.user.artist.manager.podcasts.edit')); ?>" enctype="multipart/form-data" novalidate>
                <div class="lightbox-header">
                    <h2 class="title"></h2>
                    <?php echo $__env->yieldContent('lightbox-close'); ?>
                </div>
                                ...
                                <div class="control field row mb-0">
                                    <div class="col-6">
                                        <div class="row ml-0 mr-0 mt-2 visibility-check-box">
                                            ...
                                            <label class="lbl" for="edit-podcast-visibility"><?php echo e(__('web.MAKE_PUBLIC')); ?></label>
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <div class="row ml-0 mr-0 mt-2 comments-check-box">
                                            ...
                                            <label class="lbl" for="edit-podcast-comments"><?php echo e(__('web.ALLOW_COMMENTS')); ?></label>
                                        </div>
                                    </div>
                                </div>
                                <div class="control field row mb-0">
                                    <div class="col-6">
                                        <div class="row ml-0 mr-0 mt-2 notification-check-box">
                                            ...
                                            <label class="lbl" for="edit-podcast-downloadable"><?php echo e(__('web.ALLOW_DOWNLOAD')); ?></label>
                                        </div>
                                    </div>
                                </div>
                                <div class="control field row mb-0">
                                    <div class="col-12">
                                        <div class="row ml-0 mr-0 mt-2 notification-check-box">
                                            ...
                                            <label class="lbl" for="edit-podcast-explicit" data-translate-text="PODCAST_EXPLICIT"><?php echo e(__('web.PODCAST_EXPLICIT')); ?></label>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
</div><?php /**PATH D:\ali-shiwani\laragon\www\live-streaming\resources\views\frontend\default/lightbox.blade.php ENDPATH**/ ?>