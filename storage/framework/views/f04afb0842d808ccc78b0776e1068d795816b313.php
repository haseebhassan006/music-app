<div id="footer">
    <div class="external-links">
        <a href="<?php echo e(url('page/cookies-and-personal-data')); ?>" class="footer-link" data-translate-text="HOME_COOKIE"><?php echo e(__('web.HOME_COOKIE')); ?></a>
        <span class="slash">/</span>
        <a href="<?php echo e(url('page/privacy-policy')); ?>" class="footer-link" data-translate-text="HOME_PRIVACY"><?php echo e(__('web.HOME_PRIVACY')); ?></a>
        <span class="slash">/</span>
        <a href="<?php echo e(url('page/legal-information')); ?>" class="footer-link" data-translate-text="HOME_COPYRIGHTS"><?php echo e(__('web.HOME_COPYRIGHTS')); ?></a>
        <span class="slash">/</span>
        <a href="<?php echo e(url('page/term-and-condition')); ?>" class="footer-link" data-translate-text="HOME_TERMS"><?php echo e(__('web.HOME_TERMS')); ?></a>
    </div>
    ...
    <div class="copyright text-secondary">
        <span> © <?php echo e(now()->year); ?> NiNaCoder Group. All Rights Reserved. </span>
    </div>
    <div class="love text-secondary">
        <span>Tremendously thankful for the support of Aquafina &amp; Oreo. </span>
    </div>
</div><?php /**PATH D:\ali-shiwani\laragon\www\live-streaming\resources\views\frontend\default/homepage/footer.blade.php ENDPATH**/ ?>