...
<aside id="sideMenu">
    <div id="side-logo" class="mobile">
        <a href="<?php echo e(route('frontend.homepage')); ?>" data-action="sidebar-dismiss">
            <img src="<?php echo e(asset('skins/default/images/favicon.png')); ?>">
            <span data-translate-text="HOME"><?php echo e(__('web.HOME')); ?></span>
        </a>
    </div>
    <ul id="aside_ul">
        <li class="side-menu-home desktop">
            <a href="<?php echo e(route('frontend.homepage')); ?>">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path d="M10 20v-6h4v6h5v-8h3L12 3 2 12h3v8z"/><path d="M0 0h24v24H0z" fill="none"/></svg>
                <span data-translate-text="HOME"><?php echo e(__('web.HOME')); ?></span>
            </a>
        </li>
        <li class="side-menu-discover">
            <a href="<?php echo e(route('frontend.discover')); ?>">
                ...
                <span data-translate-text="DISCOVER"><?php echo e(__('web.DISCOVER')); ?></span>
            </a>
        </li>
        <?php if(config('settings.module_community', true)): ?>
            <li class="side-menu-community">
                <a href="<?php echo e(route('frontend.community')); ?>">
                    ...
                    <span data-translate-text="COMMUNITY"><?php echo e(__('web.COMMUNITY')); ?></span>
                </a>
            </li>
        <?php endif; ?>
        <?php if(config('settings.module_podcast', true)): ?>
            <li class="side-menu-podcasts">
                <a href="<?php echo e(route('frontend.podcasts')); ?>">
                    ...
                    <span data-translate-text="PODCASTS"><?php echo e(__('web.PODCASTS')); ?></span>
                </a>
            </li>
        <?php endif; ?>
        <li class="side-menu-trending">
            <a href="<?php echo e(route('frontend.trending')); ?>">
                ...
                <span data-translate-text="TRENDING"><?php echo e(__('web.TRENDING')); ?></span>
            </a>
        </li>
        <?php if(config('settings.module_store', true)): ?>
            <li class="side-menu-store">
                <a href="<?php echo e(route('frontend.store')); ?>">
                    ...
                    <span data-translate-text="STORE"><?php echo e(__('web.STORE')); ?></span>
                </a>
            </li>
        <?php endif; ?>
        <?php if(config('settings.module_radio', true)): ?>
            <li class="side-menu-radio">
                <a href="<?php echo e(route('frontend.radio')); ?>">
                    ...
                    <span data-translate-text="RADIO"><?php echo e(__('web.RADIO')); ?></span>
                </a>
            </li>
        <?php endif; ?>
        <?php if(config('settings.module_blog', true)): ?>
            <li class="side-menu-blog">
                <a href="<?php echo e(route('frontend.blog')); ?>">
                    ...
                    <span data-translate-text="HOME_BLOG"><?php echo e(__('web.HOME_BLOG')); ?></span>
                </a>
            </li>
        <?php endif; ?>
    </ul>
    <div id="sidebar" class="scrollable">
        <div id="sidebar-playlists">
            <div id="sidebar-playlists-title" class="sidebar-title">
                <span data-translate-text="PLAYLISTS"><?php echo e(__('web.PLAYLISTS')); ?></span>
            </div>
            <div id="sidebar-no-playlists" class="hide sidebar-empty">
                <p class="label" data-translate-text="SIDEBAR_NO_PLAYLISTS"><?php echo e(__('web.SIDEBAR_NO_PLAYLISTS')); ?></p>
                <a class="btn btn-secondary new-playlist create-playlist" data-translate-text="CREATE_A_PLAYLIST"><?php echo e(__('web.CREATE_PLAYLIST')); ?></a>
            </div>
            <div id="playlists-failed" class="hide">
                <p data-translate-text="POPUP_ERROR_LOAD_PLAYLISTS"><?php echo e(__('web.POPUP_ERROR_LOAD_PLAYLISTS')); ?></p>
            </div>
            <div id="sidebar-have-playlists">
                <div class="sidebar-item">
                    <a class="sidebar-link create-playlist" data-action="sidebar-dismiss">
                        ...
                        <span data-translate-text="CREATE_PLAYLIST"><?php echo e(__('web.CREATE_PLAYLIST')); ?></span>
                    </a>
                </div>
                <a class="collapser" data-target="#sidebar-playlists-grid">
                    <span class="caret"></span>
                    <span class="title" data-translate-text="YOURS"><?php echo e(__('web.YOURS')); ?></span>
                </a>
                ...
                <a class="collapser" data-target="#sidebar-collab-playlists-grid">
                    <span class="caret"></span>
                    <span class="title" data-translate-text="COLLABORATIVE"><?php echo e(__('web.COLLABORATIVE')); ?></span>
                </a>
                <div id="sidebar-collab-playlists-grid" class="collapsable"></div>
                <a class="collapser" data-target="#sidebar-subbed-playlists-grid">
                    <span class="caret"></span>
                    <span class="title" data-translate-text="SUBSCRIBED"><?php echo e(__('web.SUBSCRIBED')); ?></span>
                </a>
...
</html><?php /**PATH D:\ali-shiwani\laragon\www\live-streaming\resources\views\frontend\default/index.blade.php ENDPATH**/ ?>