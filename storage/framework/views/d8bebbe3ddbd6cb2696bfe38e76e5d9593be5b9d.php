...
<div class="inner">
    ...
    <div class="byline">
        ...
        {% if (o.album) { %}
        <span class="has-album" data-translate-text="ON"><?php echo e(__('web.ON')); ?></span>
        ...
        <div class="actions">
            <div class="actions-right">
                ...
                <a class="btn" data-toggle="collection" data-type="song" data-id="{%=o.id%}" {% if(o.library) { %} data-init="true" {% } %}>
                    ...
                    <span class="collection-on" data-translate-text="SONG_ADD_LIBRARY"><?php echo e(__('web.SONG_ADD_LIBRARY')); ?></span>
                    <span class="collection-off" data-translate-text="CONTEXT_REMOVE_FROM_LIBRARY"><?php echo e(__('web.CONTEXT_REMOVE_FROM_LIBRARY')); ?></span>
                </a>
            </div>
        </div>
    </div>
    ...
    <div class="user">
        <div class="content">
            ...
            <div class="info">
                <h2><a></a></h2>
                <ul class="metadata">
                    <li><a><span id="song-count" class="num"></span> <span class="label" data-translate-text="SONGS"><?php echo e(__('web.SONGS')); ?></span></a></li>
                    <li><a><span id="playlist-count" class="num"></span> <span class="label" data-translate-text="PLAYLISTS"><?php echo e(__('web.PLAYLISTS')); ?></span></a></li>
                    <li><a><span id="follower-count" class="num"></span> <span class="label" data-translate-text="FOLLOWERS"><?php echo e(__('web.FOLLOWERS')); ?></span></a></li>
                </ul>
            </div>
        </div>
        <div class="actions">
            ...
            <a class="btn suggest-music" data-user-id="25">
                <svg height="26" viewBox="0 0 24 24" width="14" xmlns="http://www.w3.org/2000/svg"><path d="M0 0h24v24H0z" fill="none"></path><path d="M18 16.08c-.76 0-1.44.3-1.96.77L8.91 12.7c.05-.23.09-.46.09-.7s-.04-.47-.09-.7l7.05-4.11c.54.5 1.25.81 2.04.81 1.66 0 3-1.34 3-3s-1.34-3-3-3-3 1.34-3 3c0 .24.04.47.09.7L8.04 9.81C7.5 9.31 6.79 9 6 9c-1.66 0-3 1.34-3 3s1.34 3 3 3c.79 0 1.5-.31 2.04-.81l7.12 4.16c-.05.21-.08.43-.08.65 0 1.61 1.31 2.92 2.92 2.92 1.61 0 2.92-1.31 2.92-2.92s-1.31-2.92-2.92-2.92z"></path></svg>
                <span data-translate-text="SUGGEST_MUSIC"><?php echo e(__('web.SUGGEST_MUSIC')); ?></span>
            </a>
        </div>
    </div>
</div>
...
<script type="text/x-tmpl" id="tmpl-cart-item">
    <li class="cart__item">
        ...
        <div class="cart__item__info">
            ...
            <div class="cart__item__info__price"><span class="info-label">Price:</span><span><?php echo e(__('symbol.' . config('settings.currency', 'USD'))); ?>{%=o.price%}</span></div>
            <div class="cart__item__info__qty badge badge-secondary">{%= o.attributes.orderable_type === 'App\\Models\\Song' ? '<?php echo e(__('web.SONG')); ?>' : '<?php echo e(__('web.ALBUM')); ?>' %}</div>
        </div>
    </li>
</script>
...
</script><?php /**PATH D:\ali-shiwani\laragon\www\live-streaming\resources\views\frontend\default/jstemplate.blade.php ENDPATH**/ ?>