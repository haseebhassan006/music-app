<?php $__currentLoopData = $activities; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $activity): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    <?php if(isset($activity->details->objects) && count($activity->details->objects) && $activity->user): ?>
        <?php if( $type == 'full'): ?>
            <div class="module-feed-event <?php echo e($activity->action); ?>">
                <?php if($activity->action == 'addSong' || $activity->action == 'addEvent'): ?>
                    <a href="<?php echo e(route('frontend.artist', ['id' => $activity->details->model->id, 'slug' => $activity->details->model->name])); ?>" class="feed-user-image">
                        <img class="author-image-medium" src="<?php echo e($activity->details->model->artwork_url); ?>">
                    </a>
                <?php else: ?>
                    <a href="<?php echo e(route('frontend.user', ['username' => $activity->user->username])); ?>" class="feed-user-image" data-id="<?php echo e($activity->user->id); ?>" data-toggle="user-popover" data-placement="top" data-html="true" data-target="user-popover-container">
                        <img class="author-image-medium" src="<?php echo e($activity->user->artwork_url); ?>" alt="<?php echo e($activity->user->name); ?>">
                        <div class="feed-user-online-bubble user-online-status hide" data-username-status="<?php echo e($activity->user->username); ?>"></div>
                    </a>
                <?php endif; ?>
                <div class="feed-icon">
                    <?php if($activity->action == 'favoriteSong'): ?>
                    ...
                    <?php elseif($activity->action == 'collectSong'): ?>
                    ...
                    <?php elseif($activity->action == 'addSong'): ?>
                    ...
                    <?php elseif($activity->action == 'playSong'): ?>
                    ...
                    <?php elseif($activity->action == 'addToPlaylist'): ?>
                    ...
                    <?php elseif($activity->action == 'followUser'): ?>
                    ...
                    <?php elseif($activity->action == 'followArtist'): ?>
                    ...
                    <?php elseif($activity->action == 'followPlaylist'): ?>
                    ...
                    <?php elseif($activity->action == 'postFeed'): ?>
                ...
                <div class="feed-content">
                    <p class="event-action">
                        <?php if($activity->action == 'favoriteSong'): ?>
                            <?php echo __(count($activity->details->objects) == 1 ? 'web.FEED2_USER_FAVORITED' : 'web.FEED2_USER_FAVORITED_MANY', [
                        ...
                        <?php elseif($activity->action == 'collectSong'): ?>
                            <?php echo __(count($activity->details->objects) == 1 ? 'web.FEED2_USER_ADDED' : 'web.FEED2_USER_ADDED_MANY', [
                                'user' => htmlLink($activity->user->name, route('frontend.user', ['username' => $activity->user->username]), 'user-link'),
                                'objectCount' => count($activity->details->objects),
                                'objects' => trans('web.SONG_PLURAL'),
                                'object' => htmlLink(trans('web.SONG_ARTICLE'), $activity->details->objects[0]->permalink_url, 'song-link'),
                        ...
                        <?php elseif($activity->action == 'playSong'): ?>
                            <?php echo __(count($activity->details->objects) == 1 ? 'web.FEED2_USER_LISTENED' : 'web.FEED2_USER_LISTENED_MANY', [
                               'user' => htmlLink($activity->user->name, route('frontend.user', ['username' => $activity->user->username]), 'user-link'),
                               'objectCount' => count($activity->details->objects),
                               'objects' => trans('web.SONG_PLURAL'),
                        ...
                        <?php elseif($activity->action == 'addToPlaylist' && $activity->details->model): ?>
                            <?php echo __(count($activity->details->objects) == 1 ? 'web.FEED2_USER_ADDED' : 'web.FEED2_USER_ADDED_MANY', [
                                'user' => htmlLink($activity->user->name, route('frontend.user', ['username' => $activity->user->username]), 'user-link'),
                                'objectCount' => count($activity->details->objects),
                                'objects' => trans('web.SONG_PLURAL'),
                        ...
                        <?php elseif($activity->action == 'followUser'): ?>
                            <?php echo __(count($activity->details->objects) == 1 ? 'web.FEED2_USER_FOLLOWING' : 'web.FEED2_USER_FOLLOWING_MANY', [
                                'user' => htmlLink($activity->user->name, route('frontend.user', ['username' => $activity->user->username]), 'user-link'),
                                'objectCount' => count($activity->details->objects),
                        ...
                        <?php elseif($activity->action == 'followArtist'): ?>
                            <?php echo __(count($activity->details->objects) == 1 ? 'web.FEED2_USER_FOLLOWING' : 'web.FEED2_USER_FOLLOWING', [
                                'user' => htmlLink($activity->user->name, route('frontend.user', ['username' => $activity->user->username]), 'user-link'),
                                'objectCount' => count($activity->details->objects),
                        ...
                        <?php elseif($activity->action == 'followPlaylist'): ?>
                            <?php echo __(count($activity->details->objects) == 1 ? 'web.FEED2_USER_SUBSCRIBED' : 'web.FEED2_USER_SUBSCRIBED_MANY', [
                                'user' => htmlLink($activity->user->name, route('frontend.user', ['username' => $activity->user->username]), 'user-link'),
                                'objectCount' => count($activity->details->objects),
                        ...
                        <?php elseif($activity->action == 'addSong'): ?>
                            <?php if(isset($activity->details->model)): ?>
                                <?php echo __(count($activity->details->objects) == 1 ? 'web.FEED2_ARTIST_UPLOADED' : 'web.FEED2_ARTIST_UPLOADED_MANY', [
                            ...
                            <?php endif; ?>
                        <?php elseif($activity->action == 'addEvent'): ?>
                            <?php if(isset($activity->details->model)): ?>
                                <?php echo __('web.FEED2_ARTIST_ADDED_EVENT', [
                                    'artist' => htmlLink($activity->details->model->name, route('frontend.artist', ['id' => $activity->details->model->id, 'slug' => $activity->details->model->name]), 'user-link'),
                            ...
                            <?php endif; ?>
                        <?php elseif($activity->action == 'postFeed'): ?>
                            <?php echo __('web.FEED2_USER_POST_FEED', [
                                'user' => htmlLink($activity->user->name, route('frontend.user', ['username' => $activity->user->username]), 'user-link'),
                                'objectCount' => count($activity->details->objects),
                                'object' => htmlLink(trans('web.SONG_ARTICLE'), $activity->details->objects[0]->permalink_url, 'song-link'),
                    ...
                    <div class="feed-item">
                        <div class="feed-grid feed-grid-<?php echo e($activity->id); ?>">
                            <?php if($activity->action == 'favoriteSong' || $activity->action == 'addSong' || $activity->action == 'collectSong' || $activity->action == 'playSong' || $activity->action == 'addToPlaylist'): ?>
                                <?php echo $__env->make('commons.song', ['songs' => $activity->details->objects, 'element' => 'activity'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                            <?php elseif($activity->action == 'followUser'): ?>
                                <?php echo $__env->make('commons.user', ['users' => $activity->details->objects, 'element' => 'activity'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                            <?php elseif($activity->action == 'followArtist'): ?>
                                <?php echo $__env->make('commons.artist', ['artists' => $activity->details->objects, 'element' => 'activity'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                            <?php elseif($activity->action == 'followPlaylist'): ?>
                                <?php echo $__env->make('commons.playlist', ['playlists' => $activity->details->objects, 'element' => 'activity'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                            <?php elseif($activity->action == 'postFeed'): ?>
                                <?php if($activity->activityable_type == 'App\Models\Song'): ?>
                                    <?php echo $__env->make('commons.song', ['songs' => $activity->details->objects, 'element' => 'activity'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                <?php elseif($activity->activityable_type == 'App\Models\Album'): ?>
                                    <?php echo $__env->make('commons.album', ['albums' => $activity->details->objects, 'element' => 'activity'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                <?php elseif($activity->activityable_type == 'App\Models\Artist'): ?>
                                    <?php echo $__env->make('commons.artist', ['artists' => $activity->details->objects, 'element' => 'activity'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                <?php elseif($activity->activityable_type == 'App\Models\Playlist'): ?>
                                    <?php echo $__env->make('commons.playlist', ['playlists' => $activity->details->objects, 'element' => 'activity'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                <?php endif; ?>
                            <?php endif; ?>
                        </div>
                    ...
                    <div class="module-actions-footer">
                        <?php if($activity->action == 'favoriteSong' || $activity->action == 'playSong' || $activity->action == 'collectSong' || $activity->action == 'addToPlaylist'): ?>
                            <a class="module-footer-link feed-play play-menu" data-type="activity" data-id="<?php echo e($activity->id); ?>" data-target=".feed-grid-<?php echo e($activity->id); ?>">
                                <?php if(count($activity->details->objects) == 1): ?>
                                    <span data-translate-text="FEED_PLAY"><?php echo e(__('web.FEED_PLAY')); ?></span>
                                <?php else: ?>
                                    <span data-translate-text="FEED_PLAY_ALL"><?php echo e(__('web.FEED_PLAY_ALL')); ?></span>
                                <?php endif; ?>
                                <span class="caret"></span>
                            </a>
                            <a class="module-footer-link feed-add add-menu" data-type="activity" data-id="<?php echo e($activity->id); ?>" data-target=".feed-grid-<?php echo e($activity->id); ?>">
                                <?php if(count($activity->details->objects) == 1): ?>
                                    <span data-translate-text="FEED_ADD"><?php echo e(__('web.FEED_ADD')); ?></span>
                                <?php else: ?>
                                    <span data-translate-text="FEED_ADD_ALL"><?php echo e(__('web.FEED_ADD_ALL')); ?></span>
                                <?php endif; ?>
                                <span class="caret"></span>
                            </a>
                        <?php endif; ?>
                        <?php if(config('settings.activity_comments')): ?>
                            <a class="module-footer-link feed-respond-cta load-comments" data-toggle="comments" data-target="#activity-comment-<?php echo e($activity->id); ?>">
                                <?php if($activity->comment_count): ?>
                                    <span data-translate-text="FEED_COMMENTS_COUNT"><?php echo e(__('web.FEED_COMMENTS_COUNT', ['count' => $activity->comment_count])); ?></span>
                                <?php else: ?>
                                    <span data-translate-text="FEED_COMMENT"><?php echo e(__('web.FEED_COMMENT')); ?></span>
                                <?php endif; ?>
                                <span class="caret"></span>
                            </a>
                        <?php endif; ?>
                        <a class="module-footer-right-time">
                            <span class="time-full-string"><?php echo e(timeElapsedString($activity->created_at)); ?></span>
                            <span class="time-short-string"><?php echo e(timeElapsedShortString($activity->created_at)); ?></span>
                        </a>
                    </div>
                    <div id="activity-comment-<?php echo e($activity->id); ?>" data-commentable-type="App\Models\Activity" data-commentable-id="<?php echo e($activity->id); ?>"  class="comments-container feed-event-comments hide"></div>
                </div>
            </div>
        <?php elseif($type = 'small'): ?>
            <div class="module-feed-event module-small-feed-event <?php echo e($activity->action); ?>">
                <?php if($activity->action == 'addSong'): ?>
                    <a href="<?php echo e(route('frontend.user', ['username' => $activity->user->username])); ?>" class="feed-user-image">
                        <img class="author-image-medium" src="<?php echo e($activity->details->model->artwork_url); ?>">
                    </a>
                <?php else: ?>
                    <a href="<?php echo e(route('frontend.user', ['username' => $activity->user->username])); ?>" class="feed-user-image">
                        <img class="author-image-medium" src="<?php echo e($activity->user->artwork_url); ?>">
                        <div class="feed-user-online-bubble user-online-status hide" data-username-status="<?php echo e($activity->user->username); ?>"></div>
                    </a>
                <?php endif; ?>
                <div class="feed-icon">
                ...
                <div class="feed-content">
                    ...
                    <div class="small-event-footer">
                        ...
                        <?php endif; ?>
                        <a class="module-footer-right-time"><?php echo e(timeElapsedShortString($activity->created_at)); ?></a>
                        <?php if(auth()->check() && auth()->user()->id == $activity->user->id): ?>
                            <a class="delete-event-cta" data-id="<?php echo e($activity->id); ?>" data-translate-text="REMOVE"><?php echo e(__('web.REMOVE')); ?></a>
                        <?php endif; ?>
                    </div>
                    <div id="activity-comment-<?php echo e($activity->id); ?>" data-commentable-type="App\Models\Activity" data-commentable-id="<?php echo e($activity->id); ?>"  class="comments-container feed-event-comments hide"></div>
                </div>
        ...
        <?php endif; ?>
    <?php endif; ?>
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php /**PATH D:\ali-shiwani\laragon\www\live-streaming\resources\views\frontend\default/commons/activity.blade.php ENDPATH**/ ?>