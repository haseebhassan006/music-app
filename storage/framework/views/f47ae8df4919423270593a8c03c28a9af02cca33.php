<?php if(count($notifications)): ?>
    <?php $__currentLoopData = $notifications; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $notification): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <?php if((isset($notification->details->object) && isset($notification->details->object->permalink_url) && isset($notification->details->host)) || (isset($notification->details->object->object->object->permalink_url) && isset($notification->details->host))): ?>
            <a
                <?php if($notification->action == 'sharedMusic'): ?>
                href="<?php echo e(route('frontend.user.posts', ['username' => $notification->details->host->username, 'id' => $notification->object_id])); ?>"
                <?php elseif($notification->action == 'commentMusic' ||  $notification->action == 'commentMentioned' || $notification->action == 'replyComment'): ?>
                href="<?php echo e($notification->details->object->permalink_url); ?>?comment_id=<?php echo e($notification->object_id); ?>"
                <?php elseif($notification->action == 'reactComment'): ?>
                href="<?php echo e($notification->details->object->object->object->permalink_url); ?>?comment_id=<?php echo e($notification->object_id); ?>"
                <?php elseif($notification->action == 'inviteCollaboration' || $notification->action == 'acceptedCollaboration'): ?>
                href="<?php echo e($notification->details->object->permalink_url); ?>"
                <?php elseif($notification->action == 'addToPlaylist'): ?>
                <?php elseif($notification->action == 'followUser'): ?>
                href="<?php echo e(route('frontend.user', ['username' => $notification->details->host->username])); ?>"

                <?php elseif($notification->action == 'followArtist'): ?>
                <?php elseif($notification->action == 'followPlaylist'): ?>
                <?php elseif($notification->action == 'addEvent'): ?>
                href="<?php echo e(route('frontend.artist.events', ['id' => $notification->details->model->id, 'slug' => $notification->details->model->name])); ?>"
                <?php endif; ?>
                data-notification-id="<?php echo e($notification->id); ?>"
            >
                <div class="module-feed-event <?php echo e($notification->action); ?>">
                    <div class="feed-user-image">
                        <img class="author-image-medium" src="<?php echo e($notification->details->host->artwork_url); ?>">
                    </div>
                    <div class="feed-icon">
                        <?php if($notification->action == 'sharedMusic'): ?>
                        ...
                        <?php elseif($notification->action == 'commentMusic' || $notification->action == 'replyComment' || $notification->action == 'commentMentioned'): ?>
                        ...
                        <?php elseif($notification->action == 'reactComment'): ?>
                            <img src="<?php echo e(asset('common/reactions/' . $notification->details->object->type . '.svg')); ?>" alt="<?php echo e($notification->details->object->type); ?>">
                        <?php elseif($notification->action == 'inviteCollaboration' || $notification->action == 'acceptedCollaboration'): ?>
                    ...
                    <div class="feed-content">
                        <p class="event-action">
                            <?php if($notification->action == 'sharedMusic'): ?>
                                <?php switch($notification->notificationable_type):
                                    case ('App\Models\Song'): ?>
                                    <?php echo __('web.NOTIFICATION_USER_SHARE', ['user' => $notification->details->host->name, 'object' => trans('web.SONG_ARTICLE')]); ?>

                                    <?php break; ?>
                                    <?php case ('App\Models\Album'): ?>
                                    <?php echo __('web.NOTIFICATION_USER_SHARE', [
                                            'user' => $notification->details->host->name,
                                            'object' => trans('web.ALBUM_ARTICLE')
                                        ]); ?>

                                    <?php break; ?>
                                    <?php case ('App\Models\Playlist'): ?>
                                    <?php echo __('web.NOTIFICATION_USER_SHARE', [
                                            'user' => $notification->details->host->name,
                                    ...
                                    <?php break; ?>
                                <?php endswitch; ?>
                            <?php elseif($notification->action == 'commentMusic'): ?>
                                <?php switch($notification->notificationable_type):
                                    case ('App\Models\Song'): ?>
                                    <?php echo __('web.NOTIFICATION_USER_COMMENT', [
                                        'user' => $notification->details->host->name,
                                        'object' => trans('web.SONG_ARTICLE'),
                                        ]); ?>

                                    <?php break; ?>
                                    <?php case ('App\Models\Activity'): ?>
                                    <?php echo __('web.NOTIFICATION_USER_COMMENT', [
                                        'user' => $notification->details->host->name,
                                    ...
                                    <?php break; ?>
                                <?php endswitch; ?>
                            <?php elseif($notification->action == 'commentMentioned'): ?>
                                    <?php echo __('web.NOTIFICATION_USER_GET_COMMENT_MENTIONED', [
                                        'user' => $notification->details->host->name,
                                        'object' => trans('web.SONG_ARTICLE'),
                                        ]); ?>

                            <?php elseif($notification->action == 'inviteCollaboration'): ?>
                                <?php echo __('web.NOTIFICATION_INVITED_COLLABORATION', [
                                    'user' => $notification->details->host->name
                                    ]); ?>

                            <?php elseif($notification->action == 'acceptedCollaboration'): ?>
                                <?php echo __('web.NOTIFICATION_ACCEPTED_COLLABORATION', [
                                    'user' => $notification->details->host->name,
                                    'object' => $notification->details->object->title,
                                    ]); ?>

                            <?php elseif($notification->action == 'replyComment'): ?>
                                <?php echo __('web.NOTIFICATION_USER_REPLY_COMMENT', [
                                    'user' => $notification->details->host->name
                                    ]); ?>

                            <?php elseif($notification->action == 'reactComment'): ?>
                                <?php echo __('web.NOTIFICATION_USER_REACT_COMMENT', [
                                    'user' => $notification->details->host->name,
                                    'content' => str_limit(strip_tags($notification->details->object->object->content), 30),
                                    ]); ?>

                            <?php elseif($notification->action == 'followUser'): ?>
                                <?php echo __('web.NOTIFICATION_USER_FOLLOW', ['user' => $notification->details->host->name,]); ?>

                            <?php elseif($notification->action == 'followArtist'): ?>
                                <?php echo __(count($notification->details->objects) == 1 ? 'web.FEED2_USER_FOLLOWING' : 'web.FEED2_USER_FOLLOWING', [
                            ...
                            <?php elseif($notification->action == 'followPlaylist'): ?>
                                <?php echo __($notification->details->object->user->id == auth()->user()->id ? 'web.NOTIFICATION_USER_SUBSCRIBED_YOUR' : 'web.NOTIFICATION_USER_SUBSCRIBED', [
                            ...
                            <?php elseif($notification->action == 'addSong'): ?>
                                <?php if(isset($notification->details->model)): ?>
                                    <?php echo __(count($notification->details->objects) == 1 ? 'web.FEED2_ARTIST_UPLOADED' : 'web.FEED2_ARTIST_UPLOADED_MANY', [
                                ...
                                <?php endif; ?>
                            <?php endif; ?>
                            <span class="notification-time text-secondary"><?php echo e(timeElapsedString($notification->created_at)); ?></span>
                        </p>
                        <?php if($notification->action == 'inviteCollaboration'): ?>
                            <div class="row mb-3">
                                <div class="col-6">
                                    <button class="btn btn-primary btn-block" data-toggle="collaboration" data-action="accept" data-playlist-id="<?php echo e($notification->details->object->id); ?>" data-notification-id="<?php echo e($notification->id); ?>"><?php echo e(__('web.ACCEPT')); ?></button>
                                </div>
                                <div class="col-6">
                                    <button class="btn btn-secondary btn-block" data-toggle="collaboration" data-action="cancel" data-playlist-id="<?php echo e($notification->details->object->id); ?>" data-notification-id="<?php echo e($notification->id); ?>"><?php echo e(__('web.CANCEL')); ?></button>
                                </div>
                            </div>
                        <?php endif; ?>
                    </div>
                    <span class="module-time text-secondary"><?php echo e(timeElapsedString($notification->created_at)); ?></span>
                </div>
            </a>
        <?php endif; ?>
        <?php if(isset($notification->details->objects) && isset($notification->details->objects[0]) && isset($notification->details->model)): ?>
            <a
                    <?php if($notification->action == 'addToPlaylist'): ?>
                    href="<?php echo e($notification->details->model->permalink_url); ?>"
                    <?php elseif($notification->action == 'addSong'): ?>
                    href="<?php echo e(route('frontend.artist', ['id' => $notification->details->model->id, 'slug' => $notification->details->model->name])); ?>"
                    <?php elseif($notification->action == 'addEvent'): ?>
                    href="<?php echo e(route('frontend.artist.events', ['id' => $notification->details->model->id, 'slug' => $notification->details->model->name])); ?>"
                    <?php endif; ?>
            ...
            >
                <div class="module-feed-event <?php echo e($notification->action); ?>">
                    <?php if($notification->action == 'addSong' || $notification->action == 'addEvent'): ?>
                        <div class="feed-user-image">
                            <img class="author-image-medium" src="<?php echo e($notification->details->model->artwork_url); ?>">
                        </div>
                    <?php else: ?>
                        <div href="<?php echo e(route('frontend.user', ['username' => $notification->user->username])); ?>" class="feed-user-image">
                            <img class="author-image-medium" src="<?php echo e($notification->user->artwork_url); ?>">
                            <div class="feed-user-online-bubble user-online-status hide" data-username-status="<?php echo e($notification->user->username); ?>"></div>
                        </div>
                    <?php endif; ?>
                    <div class="feed-icon">
                        <?php if($notification->action == 'addSong'): ?>
                    ...
                    <div class="feed-content">
                        <p class="event-action">
                            <?php if($notification->action == 'addEvent'): ?>
                                <?php if(isset($notification->details->model)): ?>
                            ...
                            <?php elseif($notification->action == 'addToPlaylist'): ?>
                                <?php if(isset($notification->details->model)): ?>
                                    <?php echo __(count($notification->details->objects) == 1 ? 'web.NOTIFICATION_USER_ADDED' : 'web.NOTIFICATION_USER_ADDED_MANY', [
                            ...
                            <?php elseif($notification->action == 'addSong'): ?>
                                <?php if(isset($notification->details->model)): ?>
                                    <?php echo __(count($notification->details->objects) == 1 ? 'web.NOTIFICATION_ARTIST_UPLOADED' : 'web.NOTIFICATION_ARTIST_UPLOADED_MANY', [
                                        'artist' => $notification->details->model->name,
                                        'objectCount' => count($notification->details->objects),
                                        'objects' => trans('web.SONG_PLURAL'),
                                        'object' => trans('web.SONG_ARTICLE'),
...
<?php else: ?>
    <p class="no-notifications" data-translate-text="YOU_HAVE_NO_NOTIFS"><?php echo e(__('web.YOU_HAVE_NO_NOTIFS')); ?></p>
<?php endif; ?><?php /**PATH C:\laragon\www\live-streaming\resources\views\frontend\default/commons/notification.blade.php ENDPATH**/ ?>