...
<div class="module module-comment">
    ...
    <div class="comment-footer">
        ...
        <a class="comment-reply-link respond-cta"><span data-translate-text="REPLY"><?php echo e(__('web.REPLY')); ?></span></a>
        <span aria-hidden="true">&nbsp;·&nbsp;</span>
    ...
    <div class="comment-response-container">
        ...
        {%  } %}
        <form class="module-item-respond response-row hide" method="post" action="<?php echo e(route('frontend.comments.reply')); ?>" novalidate>
...
<?php /**PATH D:\ali-shiwani\laragon\www\live-streaming\resources\views\frontend\default/comments/templates/comment.blade.php ENDPATH**/ ?>